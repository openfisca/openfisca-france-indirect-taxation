...
# et par décile de revenu disponible
    ...
    varlist = ['somme_coicop12','rev_disp_loyerimput','montant_tva_total', 'montant_droit_d_accise_alcool', 'montant_droit_d_accise_tabac', 'montant_taxe_assurance', 'montant_tipp']
    Wconcat = df_weighted_average_grouped(dataframe = df, groupe = 'decile', varlist = varlist)

    # Example
    list_taux_d_effort = []
    Wconcat['taux_d_effort_tva'] = Wconcat['montant_tva_total'] / Wconcat['somme_coicop12']
    list_taux_d_effort.append('taux_d_effort_tva')

    Wconcat['taux_d_effort_alcool'] = Wconcat['montant_droit_d_accise_alcool'] / Wconcat['somme_coicop12']
    list_taux_d_effort.append('taux_d_effort_alcool')

    Wconcat['taux_d_effort_tabac'] = Wconcat['montant_droit_d_accise_tabac'] / Wconcat['somme_coicop12']
    list_taux_d_effort.append('taux_d_effort_tabac')

    Wconcat['taux_d_effort_assurance'] = Wconcat['montant_taxe_assurance'] / Wconcat['somme_coicop12']
    list_taux_d_effort.append('taux_d_effort_assurance')

    Wconcat['taux_d_effort_tipp'] = Wconcat['montant_tipp'] / Wconcat['somme_coicop12']
