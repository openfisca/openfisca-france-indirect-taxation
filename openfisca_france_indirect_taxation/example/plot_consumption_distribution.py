...
# Exemple: graphe par décile de revenu par uc de la ventilation de la consommation selon les postes agrégés de la CN
    ...
    var_to_be_simulated = [
        ...
        'ocde10',
        'niveau_de_vie',
        'consommation_coicop12_1',
        'consommation_coicop12_2',
        'consommation_coicop12_3',
        'consommation_coicop12_4',
        'consommation_coicop12_5',
        'consommation_coicop12_6',
        'consommation_coicop12_7',
        'consommation_coicop12_8',
        'consommation_coicop12_9',
        'consommation_coicop12_10',
        'consommation_coicop12_11',
        'consommation_coicop12_12',
        'coicop12_1',
        'coicop12_2',
        'coicop12_3',
        'coicop12_4',
