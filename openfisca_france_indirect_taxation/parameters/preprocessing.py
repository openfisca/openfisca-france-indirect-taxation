...
def calculate_ht_price(ttc_price, tva_rate, ticpe, majoration_regionale_ticpe, affectation_regionale_ticpe):
    return (ttc_price / (1 + tva_rate)) - (ticpe + majoration_regionale_ticpe + affectation_regionale_ticpe)
