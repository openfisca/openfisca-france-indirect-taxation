...
for year in [2000, 2005, 2011]:
    ...
    df = pd.melt(data, id_vars=["vag", "ident_men"], value_vars=produits, value_name="depense_bien", var_name="bien")
    ...
    df[["prix", "depense_bien", "depense_par_coicop"]] = df[["prix", "depense_bien", "depense_par_coicop"]].astype(
        float
    )
    ...
    df_info_menage[["poste_coicop_2201", "poste_coicop_2202", "poste_coicop_2203"]] = df_info_menage[
    ...
    df_info_menage.drop(
        ["consommation_tabac", "poste_coicop_2201", "poste_coicop_2202", "poste_coicop_2203"], inplace=True, axis=1
    )
    ...
    data_frame[["depenses_tot", "depense_par_coicop"]] = data_frame[["depenses_tot", "depense_par_coicop"]].astype(
        float
    )
    ...
    data_frame.loc[data_frame["indice_prix_pondere"] == 0, "indice_prix_pondere"] = data_frame.loc[
        data_frame["indice_prix_pondere"] == 0, "prix_coicop"
    ]
    ...
    data_frame_prix = pd.pivot_table(
        data_frame_prix, index="ident_men", columns="numero_coicop", values="indice_prix_pondere"
    )
    ...
    data_frame2 = pd.pivot_table(data_frame, index="ident_men", columns="numero_coicop", values="wi")
    for i in range(1, 13):
    ...
    data_frame.drop(
        ["depense_par_coicop", "depenses_tot", "indice_prix_pondere", "wi", "numero_coicop"], inplace=True, axis=1
    )
