...
for year in [2005]:
    ...
    energie_logement = ['poste_coicop_451', 'poste_coicop_4511', 'poste_coicop_452', 'poste_coicop_4522',
                        'poste_coicop_453', 'poste_coicop_454']
    ...
    for alime in produits_alimentaire:
        aggregates_data_frame['depenses_alime'] += aggregates_data_frame[alime]
    ...
    data_conso = aggregates_data_frame[produits + ['vag'] + ['depenses_alime'] + ['depenses_autre'] +
        ['depenses_carbu'] + ['depenses_logem']].copy()
...
#    df = df[['ident_men'] + ['coicop_12_numero'] + ['indice_prix_produit'] + ['depense_bien'] + ['vag']]
    ...
    grouped_logem = grouped[grouped['categorie'] == 'logem']
    ...
    df_info_menage = aggregates_data_frame[['agepr'] + ['depenses_alime'] + ['depenses_autre'] + ['depenses_carbu'] +
        ...
        ['situacj'] + ['situapr'] + ['stalog'] + ['strate'] + ['typmen'] + ['vag']]
    ...
    dataframe = dataframe[['ident_men'] + ['part_carbu'] + ['part_alime'] + ['part_autre'] + ['prix_carbu'] +
        ['prix_alime'] + ['prix_autre'] + ['depenses_par_uc'] + ['depenses_tot'] + ['typmen'] + ['strate'] +
        ['dip14pr'] + ['agepr'] + ['situapr'] + ['situacj'] + ['stalog'] + ['nenfants'] + ['nactifs']]
...
data_frame_for_reg = add_area_dummy(data_frame_for_reg)

# Improve price estimation for fuel
# Must correct what is useless, improve demographics
# Add fixed effects for vag
