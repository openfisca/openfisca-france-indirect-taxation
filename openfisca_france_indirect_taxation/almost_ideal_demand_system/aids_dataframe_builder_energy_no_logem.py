...
for year in [2000, 2005, 2011]:
    ...
    data_conso = aggregates_data_frame[
        produits + ["vag", "ident_men", "depenses_alime", "depenses_autre", "depenses_carbu"]
    ].copy()
    ...
    df_depenses_prix = pd.merge(
        df_depenses_prix,
        data_conso[["depenses_alime", "depenses_autre", "depenses_carbu", "ident_men"]],
        on="ident_men",
    )
    del data_conso
    df_depenses_prix[["depenses_alime", "depenses_autre", "depense_bien", "depenses_carbu", "prix"]] = df_depenses_prix[
        ["depenses_alime", "depenses_autre", "depense_bien", "depenses_carbu", "prix"]
    ].astype(float)
