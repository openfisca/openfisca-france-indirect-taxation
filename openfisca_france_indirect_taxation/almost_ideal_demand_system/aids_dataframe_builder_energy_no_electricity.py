...
for year in [2000, 2005, 2011, 2017]:
    ...
    for bien in biens_durables:
        ...
        energie_logement = [
            ...
            "poste_04_5_3_1_1",
            "poste_04_5_4_1_1",
        ]  # 'poste_04_5_1_1_1_a', 'poste_04_5_1_1_1_b', l'électricité est exclue
    ...
    data_frame_for_reg.to_csv(
        os.path.join(assets_directory, "quaids", "data_frame_energy_no_electricity_{}.csv".format(year)), sep=","
    )

data_frame_all_years.to_csv(
    os.path.join(assets_directory, "quaids", "data_frame_energy_no_electricity_all_years.csv"), sep=","
)
