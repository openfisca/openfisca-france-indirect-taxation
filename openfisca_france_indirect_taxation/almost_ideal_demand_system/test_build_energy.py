...
for i in range(0, 100):
    ...
    assert (
        0.999 < df_ident_men_0_alime["part_bien_categorie"].sum() < 1.001
        or -0.001 < df_ident_men_0_alime["part_bien_categorie"].sum() < 0.001
    )

    df_ident_men_0_autre = df_ident_men_0[df_ident_men_0["type_bien"] == "autre"]
    assert (
        0.999 < df_ident_men_0_autre["part_bien_categorie"].sum() < 1.001
        or -0.001 < df_ident_men_0_autre["part_bien_categorie"].sum() < 0.001
    )

    df_ident_men_0_carbu = df_ident_men_0[df_ident_men_0["type_bien"] == "carbu"]
    assert (
        0.999 < df_ident_men_0_carbu["part_bien_categorie"].sum() < 1.001
        or -0.001 < df_ident_men_0_carbu["part_bien_categorie"].sum() < 0.001
    )
