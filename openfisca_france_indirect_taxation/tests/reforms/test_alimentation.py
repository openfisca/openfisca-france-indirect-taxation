...
def test_reforme_alimentation():
    ...
    assert_near(reform_tva_taux_super_reduit, 100 * 0.021 / (1 + 0.021), absolute_error_margin=absolute_error_margin)

    assert_near(
        reference_tva_taux_super_reduit, 2 * 100 * 0.021 / (1 + 0.021), absolute_error_margin=absolute_error_margin
    )
    ...
    assert_near(reference_depenses_vin, 100, absolute_error_margin=absolute_error_margin)
    assert_near(reform_depenses_vin, 0, absolute_error_margin=absolute_error_margin)
