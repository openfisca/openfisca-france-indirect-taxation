...
def modify_parameters(parameters):
    ...
    parameters.prestations.add_child(
        "cheque_energie_reforme", FranceIndirectTaxationTaxBenefitSystem().parameters.prestations.cheque_energie
    )
...
class officielle_2019_in_2017(Reform):
    ...
    class combustibles_liquides_ticpe_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            reforme_combustibles_liquides = parameters(
                period.start
            ).officielle_2019_in_2017.combustibles_liquides_2019_in_2017
            ...
            depenses_combustibles_liquides_ajustees = menage(
                "depenses_combustibles_liquides_officielle_2019_in_2017", period
            )
    ...
    class depenses_combustibles_liquides_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_combustibles_liquides_officielle_2019_in_2017 = depenses_combustibles_liquides * (
                1
                + (1 + combustibles_liquides_elasticite_prix)
    ...
    class depenses_diesel_corrigees_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_officielle_2019_in_2017 = depenses_diesel * (
                1 + (1 + carburants_elasticite_prix) * reforme_diesel * (1 + taux_plein_tva) / diesel_ttc
            )
    ...
    class depenses_essence_corrigees_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_essence_officielle_2019_in_2017 = depenses_essence * (
                1 + (1 + carburants_elasticite_prix) * reforme_essence * (1 + taux_plein_tva) / super_95_ttc
            )
    ...
    class depenses_gaz_variables_cale(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            depenses_gaz_variables = depenses_gaz_variables * (
                ...
                / sum(
                    ponderations
                    * (depenses_gaz_variables / depenses_gaz_prix_unitaire * (depenses_gaz_prix_unitaire != 0.001))
                )
            )
    ...
    class depenses_gaz_ville_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_gaz_variables = depenses_gaz_variables * (
                1 + (1 + gaz_elasticite_prix) * reforme_gaz * (1 + taux_plein_tva) / depenses_gaz_prix_unitaire
            )
            ...
            depenses_gaz_ajustees = (depenses_gaz_variables + depenses_gaz_tarif_fixe) * (
                depenses_gaz_prix_unitaire != 0.001
            )
    ...
    class diesel_ticpe_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            majoration_ticpe_diesel = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.majoration_regionale_ticpe_gazole[42]  # alsace
            ...
            depenses_diesel_officielle_2019_in_2017 = menage(
                "depenses_diesel_corrigees_officielle_2019_in_2017", period
            )
            depenses_diesel_htva_ajustees = depenses_diesel_officielle_2019_in_2017 - tax_from_expense_including_tax(
                depenses_diesel_officielle_2019_in_2017, taux_plein_tva
            )
    ...
    class diesel_ticpe_test(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_officielle_2019_in_2017 = menage("depenses_diesel", period)
            depenses_diesel_htva_ajustees = depenses_diesel_officielle_2019_in_2017 - tax_from_expense_including_tax(
                depenses_diesel_officielle_2019_in_2017, taux_plein_tva
            )
            montant_diesel_ticpe_ajuste = tax_from_expense_including_tax(
    ...
    class gains_tva_carburants_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_essence_corrigees_officielle_2019_in_2017 = menage(
                "depenses_essence_corrigees_officielle_2019_in_2017", period
            )
            depenses_diesel_corrigees_officielle_2019_in_2017 = menage(
                "depenses_diesel_corrigees_officielle_2019_in_2017", period
            )
            tva_depenses_carburants_corrigees_officielle_2019_in_2017 = (taux_plein_tva / (1 + taux_plein_tva)) * (
                depenses_essence_corrigees_officielle_2019_in_2017 + depenses_diesel_corrigees_officielle_2019_in_2017
            )
            depenses_essence = menage("depenses_essence", period)
            depenses_diesel = menage("depenses_diesel", period)
            tva_depenses_carburants_corrigees = (taux_plein_tva / (1 + taux_plein_tva)) * (
                depenses_essence + depenses_diesel
            )
            gains_tva_carburants = (
                tva_depenses_carburants_corrigees_officielle_2019_in_2017 - tva_depenses_carburants_corrigees
            )
    ...
    class gains_tva_combustibles_liquides_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_combustibles_liquides_officielle_2019_in_2017 = menage(
                "depenses_combustibles_liquides_officielle_2019_in_2017", period
            )
            ...
            gains_tva_combustibles_liquides = (
                tva_depenses_combustibles_liquides_officielle_2019_in_2017 - tva_depenses_combustibles_liquides
            )
    ...
    class gains_tva_gaz_ville_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            tva_depenses_gaz_ville_officielle_2019_in_2017 = (taux_plein_tva / (1 + taux_plein_tva)) * (
                depenses_gaz_ville_officielle_2019_in_2017 - depenses_gaz_tarif_fixe
            )
            depenses_gaz_variables = menage("depenses_gaz_variables_cale", period)
            tva_depenses_gaz_ville = (taux_plein_tva / (1 + taux_plein_tva)) * (depenses_gaz_variables)
            gains_tva_gaz_ville = tva_depenses_gaz_ville_officielle_2019_in_2017 - tva_depenses_gaz_ville
    ...
    class quantites_gaz_final_cale(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            quantites_gaz_cale = (depenses_gaz_variables / depenses_gaz_prix_unitaire) * (
                1 - (depenses_gaz_prix_unitaire == 0.001)
            )
    ...
    class revenu_reforme_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total_taxes_energies_officielle_2019_in_2017 = menage(
                "total_taxes_energies_officielle_2019_in_2017", period
            )
    ...
    class sp_e10_ticpe_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_officielle_2019_in_2017 = menage(
                "depenses_essence_corrigees_officielle_2019_in_2017", period
            )
    ...
    class sp_e10_ticpe_test(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_officielle_2019_in_2017 = menage("depenses_essence", period)
            part_sp_e10 = parameters(period.start).imposition_indirecte.part_type_supercarburants.sp_e10
            sp_e10_depenses_ajustees = depenses_essence_officielle_2019_in_2017 * part_sp_e10
            sp_e10_depenses_htva_ajustees = sp_e10_depenses_ajustees - tax_from_expense_including_tax(
                sp_e10_depenses_ajustees, taux_plein_tva
    ...
    class ticgn(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            taux_ticgn = (
                parameters(
                    period.start
                ).imposition_indirecte.taxes_energie_dans_logement.taxes_electricite_et_gaz.ticgn_prix_par_mwh
                / 1000
            )
