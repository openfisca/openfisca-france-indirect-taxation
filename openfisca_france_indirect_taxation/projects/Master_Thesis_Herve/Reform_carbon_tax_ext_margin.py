...
class carbon_tax_rv_ext_margin(Reform):
    key = 'carbon_tax_rv_ext_margin',
    name = "Réforme de la fiscalité des énergies de 2019 par rapport aux taux de 2018 avec des réponses à la marge extensive",
    ...
    class bonus_cheques_energie_uc(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Montant du bonus de chèques énergie réparti uniformément (indexés par uc) - taxe carbone (avec réponses marge intensive et extensive)"
    ...
    class bonus_cheques_energie_menage(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Montant du bonus de chèques énergie réparti uniformément par ménage - taxe carbone (avec réponses marge intensive et extensive)"
    ...
    class contributions_reforme(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total_ticpe_carbon_tax_rv_ext_margin = menage('ticpe_totale_carbon_tax_rv_ext_margin',period)

            contribution = total_ticpe_carbon_tax_rv_ext_margin - total_ticpe
    ...
    class depenses_carburants_corrigees_carbon_tax_rv(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Depenses en carburants après reaction (à la marge intensive uniquement) à la reforme"
    ...
    class depenses_carburants_corrigees_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Depenses en carburants après reaction (marge intensive et extensive) à la reforme"

        def formula(menage, period, parameters):
            depenses_diesel_ajustees_ext_margin = menage('depenses_diesel_corrigees_carbon_tax_rv_ext_margin', period)
            depenses_essence_ajustees_ext_margin = menage('depenses_essence_corrigees_carbon_tax_rv_ext_margin', period)
            depenses_carburants_ajustees_ext_margin = depenses_diesel_ajustees_ext_margin + depenses_essence_ajustees_ext_margin
            return depenses_carburants_ajustees_ext_margin

    class depenses_diesel_corrigees_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Dépenses en diesel après réaction (marge intensive et extensive) à la réforme"

        def formula(menage, period, parameters):
            variation_depenses_diesel = menage('variation_depenses_diesel_no_response',period)
            depenses_diesel_carbon_tax_rv = menage('depenses_diesel_corrigees_carbon_tax_rv',period)
            elasticite_marge_extensive = 0.1
            depenses_diesel_carbon_tax_rv_ext_margin = (1-elasticite_marge_extensive*variation_depenses_diesel)*depenses_diesel_carbon_tax_rv
            return depenses_diesel_carbon_tax_rv_ext_margin
    ...
    class depenses_essence_corrigees_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Dépenses en essence après réaction (marge intensive et extensive) à la réforme"

        def formula(menage, period, parameters):
            variation_depenses_essence = menage('variation_depenses_essence_no_response',period)
            depenses_essence_carbon_tax_rv = menage('depenses_essence_corrigees_carbon_tax_rv',period)
            elasticite_marge_extensive = 0.1
            depenses_essence_carbon_tax_rv_ext_margin = (1-elasticite_marge_extensive*variation_depenses_essence)*depenses_essence_carbon_tax_rv
            return depenses_essence_carbon_tax_rv_ext_margin
    ...
    class diesel_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de TICPE sur le diesel après réforme (avec réponses à la marge intensive et extensive)"
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_carbon_tax_rv = \
                menage('depenses_diesel_corrigees_carbon_tax_rv_ext_margin', period)
            depenses_diesel_htva_ajustees = (
                depenses_diesel_carbon_tax_rv
                - tax_from_expense_including_tax(depenses_diesel_carbon_tax_rv, taux_plein_tva)
                )
    ...
    class quantite_diesel_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul des quantités de diesel après réforme (en hL) et réponses à la marge intensive et extensive"
    ...
    class essence_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de la TICPE sur toutes les essences cumulées, après réforme (réponse intesive et extensive)"

        def formula_2009(menage, period):
            sp95_ticpe_ajustee = menage('sp95_ticpe_carbon_tax_rv_ext_margin', period)
            sp98_ticpe_ajustee = menage('sp98_ticpe_carbon_tax_rv_ext_margin', period)
            sp_e10_ticpe_ajustee = menage('sp_e10_ticpe_carbon_tax_rv_ext_margin', period)
            essence_ticpe_ajustee = (sp95_ticpe_ajustee + sp98_ticpe_ajustee + sp_e10_ticpe_ajustee)
            return essence_ticpe_ajustee
        ...
        def formula_1990(menage, period, parameters):
            sp95_ticpe_ajustee = menage('sp95_ticpe_carbon_tax_rv_ext_margin', period)
            sp98_ticpe_ajustee = menage('sp98_ticpe_carbon_tax_rv_ext_margin', period)
            super_plombe_ticpe_ajustee = menage('super_plombe_ticpe_carbon_tax_rv_ext_margin', period)
            essence_ticpe_ajustee = (sp95_ticpe_ajustee + sp98_ticpe_ajustee + super_plombe_ticpe_ajustee)
            return essence_ticpe_ajustee
    ...
    class quantite_essence_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul des quantités de toutes les essences cumulées, après réforme (en hL)"

        def formula_2009(menage, period):
            quantite_sp95_ajustee = menage('quantite_sp95_carbon_tax_rv_ext_margin', period)
            quantite_sp98_ajustee = menage('quantite_sp98_carbon_tax_rv_ext_margin', period)
            quantite_sp_e10_ajustee = menage('quantite_sp_e10_carbon_tax_rv_ext_margin', period)
            quantite_essence_ajustee = (quantite_sp95_ajustee + quantite_sp98_ajustee + quantite_sp_e10_ajustee)
            return quantite_essence_ajustee
        ...
        def formula_1990(menage, period, parameters):
            quantite_sp95_ajustee = menage('quantite_sp95_carbon_tax_rv_ext_margin', period)
            quantite_sp98_ajustee = menage('quantite_sp98_carbon_tax_rv_ext_margin', period)
            quantite_super_plombe_ajustee = menage('quantite_super_plombe_carbon_tax_rv_ext_margin', period)
            quantite_essence_ajustee = (quantite_sp95_ajustee + quantite_sp98_ajustee + quantite_super_plombe_ajustee)
            return quantite_essence_ajustee
    ...
    class emissions_CO2_carburants_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Emissions de CO2 des ménages via leur consommation de carburants après réforme, en kg de CO2"
        # use_baseline =emissions_co2.emissions_CO2_carburants
        ...
        def formula(menage, period, parameters):
            quantites_diesel_ajustees = menage('quantite_diesel_carbon_tax_rv_ext_margin', period)
            quantites_essence_ajustees = menage('quantite_essence_carbon_tax_rv_ext_margin', period)
            emissions_diesel = DIESEL_KG_CO2_PAR_HL
                #parameters(period.start).imposition_indirecte.emissions_CO2.carburants.CO2_diesel
            emissions_essence = ESSENCE_KG_CO2_PAR_HL
                #parameters(period.start).imposition_indirecte.emissions_CO2.carburants.CO2_essence
    ...
    class revenu_reforme_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Revenu généré par la réforme officielle 2018 avant redistribution"
        ...
        def formula(menage, period):
            total_ticpe = menage('ticpe_totale',period)
            total_ticpe_carbon_tax_rv_ext_margin = menage('ticpe_totale_carbon_tax_rv_ext_margin',period)
            total_gains_tva_carburants_carbon_tax_rv_ext_margin = menage('gains_tva_carburants_carbon_tax_rv_ext_margin', period)

            revenu_reforme = (total_ticpe_carbon_tax_rv_ext_margin - total_ticpe) + total_gains_tva_carburants_carbon_tax_rv_ext_margin                
    ...
    class gains_tva_carburants_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Recettes en TVA sur les carburants de la réforme"
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_essence_corrigees_carbon_tax_rv_ext_margin = \
                menage('depenses_essence_corrigees_carbon_tax_rv_ext_margin', period)
            depenses_diesel_corrigees_carbon_tax_rv_ext_margin = \
                menage('depenses_diesel_corrigees_carbon_tax_rv_ext_margin', period)
            tva_depenses_carburants_corrigees_carbon_tax_rv_ext_margin = (
                (taux_plein_tva / (1 + taux_plein_tva))
                * (depenses_essence_corrigees_carbon_tax_rv_ext_margin + depenses_diesel_corrigees_carbon_tax_rv_ext_margin)
                )
            depenses_essence = \
                menage('depenses_essence', period)
            depenses_diesel = \
    ...
    class ticpe_totale_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de la TICPE sur tous les carburants cumulés, après réforme"

        def formula(menage, period):
            essence_ticpe_ajustee = menage('essence_ticpe_carbon_tax_rv_ext_margin', period)
            diesel_ticpe_ajustee = menage('diesel_ticpe_carbon_tax_rv_ext_margin', period)
            ticpe_totale_ajustee = diesel_ticpe_ajustee + essence_ticpe_ajustee
    ...
    class sp_e10_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de la TICPE sur le SP E10 après réforme"
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_carbon_tax_rv_ext_margin = \
                menage('depenses_essence_corrigees_carbon_tax_rv_ext_margin', period)
            part_sp_e10 = parameters(period.start).imposition_indirecte.part_type_supercarburants.sp_e10
            sp_e10_depenses_ajustees = depenses_essence_carbon_tax_rv_ext_margin * part_sp_e10
            sp_e10_depenses_htva_ajustees = \
                sp_e10_depenses_ajustees - tax_from_expense_including_tax(sp_e10_depenses_ajustees, taux_plein_tva)
            montant_sp_e10_ticpe_ajuste = \
                tax_from_expense_including_tax(sp_e10_depenses_htva_ajustees, taux_implicite_sp_e10_ajuste)
    ...
    class quantite_sp_e10_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul des quantités de SP E10, après réforme (en hL)"
    ...
    class sp95_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de TICPE sur le sp_95 après réforme"
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_carbon_tax_rv_ext_margin = \
                menage('depenses_essence_corrigees_carbon_tax_rv_ext_margin', period)
            part_sp95 = parameters(period.start).imposition_indirecte.part_type_supercarburants.sp_95
            depenses_sp_95_ajustees = depenses_essence_carbon_tax_rv_ext_margin * part_sp95
            depenses_sp_95_htva_ajustees = (
                depenses_sp_95_ajustees - tax_from_expense_including_tax(depenses_sp_95_ajustees, taux_plein_tva)
                )
            montant_sp95_ticpe_ajuste = (
    ...
    class quantite_sp95_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul des quantités de sp_95, après réforme (en hL)"
    ...
    class sp98_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de TICPE sur le sp_98 après réforme"
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_carbon_tax_rv_ext_margin = \
                menage('depenses_essence_corrigees_carbon_tax_rv_ext_margin', period)
            part_sp98 = parameters(period.start).imposition_indirecte.part_type_supercarburants.sp_98
            depenses_sp_98_ajustees = depenses_essence_carbon_tax_rv_ext_margin * part_sp98
            depenses_sp_98_htva_ajustees = (
                depenses_sp_98_ajustees - tax_from_expense_including_tax(depenses_sp_98_ajustees, taux_plein_tva)
                )
            montant_sp98_ticpe_ajuste = (
    ...
    class quantite_sp98_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul des quantités de sp_98, après réforme (en hL)"
    ...
    class super_plombe_ticpe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
        label = "Calcul du montant de la TICPE sur le super plombé après réforme"
        ...
        def formula(menage, period, parameters):
            ...
            part_super_plombe = \
                parameters(period.start).imposition_indirecte.part_type_supercarburants.super_plombe
            depenses_super_plombe_ajustees = depenses_essence_carbon_tax_rv_ext_margin * part_super_plombe
            depenses_super_plombe_htva_ajustees = (
                depenses_super_plombe_ajustees
                - tax_from_expense_including_tax(depenses_super_plombe_ajustees, taux_plein_tva)
                )
    ...
    class quantite_super_plombe_carbon_tax_rv_ext_margin(YearlyVariable):
        value_type = float
        entity = Menage
