...
class carbon_tax_rv(Reform):
    ...
    class depenses_diesel_corrigees_carbon_tax_rv(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_carbon_tax_rv = depenses_diesel * (
            ...
            depenses_diesel_corrigees_carbon_tax_rv = (
                1 - elasticite_marge_extensive * variation_depenses_diesel
    ...
    class depenses_essence_corrigees_carbon_tax_rv(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            reforme_essence = parameters(period.start).carbon_tax_rv.essence_with_carbon_tax_rv
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_essence_carbon_tax_rv = depenses_essence * (
            ...
            depenses_essence_corrigees_carbon_tax_rv = (
                1 - elasticite_marge_extensive * variation_depenses_essence
    ...
    class diesel_ticpe_carbon_tax_rv(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_htva_ajustees = depenses_diesel_carbon_tax_rv - tax_from_expense_including_tax(
                depenses_diesel_carbon_tax_rv, taux_plein_tva
            )
    ...
    class diesel_ticpe_test(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_carbon_tax_rv = menage("depenses_diesel", period)
            depenses_diesel_htva_ajustees = depenses_diesel_carbon_tax_rv - tax_from_expense_including_tax(
                depenses_diesel_carbon_tax_rv, taux_plein_tva
            )
            montant_diesel_ticpe_ajuste = tax_from_expense_including_tax(
    ...
    class emissions_CO2_carburants(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            emissions_essence = ESSENCE_KG_CO2_PAR_HL
            # parameters(period.start).imposition_indirecte.emissions_CO2.carburants.CO2_essence
            emissions_totales = (quantites_diesel * emissions_diesel) + (
    ...
    class gains_tva_carburants_carbon_tax_rv(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_essence_corrigees_carbon_tax_rv = menage("depenses_essence_corrigees_carbon_tax_rv", period)
            depenses_diesel_corrigees_carbon_tax_rv = menage("depenses_diesel_corrigees_carbon_tax_rv", period)
            tva_depenses_carburants_corrigees_carbon_tax_rv = (taux_plein_tva / (1 + taux_plein_tva)) * (
            ...
            gains_tva_carburants = tva_depenses_carburants_corrigees_carbon_tax_rv - tva_depenses_carburants_corrigees
    ...
    class sp_e10_ticpe_test(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_essence_carbon_tax_rv = menage("depenses_essence", period)
            part_sp_e10 = parameters(period.start).imposition_indirecte.part_type_supercarburants.sp_e10
            sp_e10_depenses_ajustees = depenses_essence_carbon_tax_rv * part_sp_e10
            sp_e10_depenses_htva_ajustees = sp_e10_depenses_ajustees - tax_from_expense_including_tax(
                sp_e10_depenses_ajustees, taux_plein_tva
