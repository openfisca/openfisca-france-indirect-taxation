...
df['depenses_cigarettes_janvier_2019'] = df['depenses_cigarettes_2017'] * (1 + (1 + elasticite_tabac) * ((7.9 - 7.1) / 7.1))
df['depenses_cigarettes_avril_2019'] = df['depenses_cigarettes_2017'] * (1 + (1 + elasticite_tabac) * ((8.4 - 7.1) / 7.1))
df['depenses_cigarettes_novembre_2019'] = df['depenses_cigarettes_2017'] * (1 + (1 + elasticite_tabac) * ((8.9 - 7.1) / 7.1))
...
df['depenses_tabac_a_rouler_janvier_2019'] = df['depenses_tabac_a_rouler'] * (1 + (1 + elasticite_tabac) * ((10.8 - 8.8) / 8.8))
df['depenses_tabac_a_rouler_avril_2019'] = df['depenses_tabac_a_rouler'] * (1 + (1 + elasticite_tabac) * ((11.7 - 8.8) / 8.8))
df['depenses_tabac_a_rouler_novembre_2019'] = df['depenses_tabac_a_rouler'] * (1 + (1 + elasticite_tabac) * ((12.6 - 8.8) / 8.8))
...
## Test
resultats_a_reproduire = pd.read_csv("../../assets/tests/resultats_reformes_tabac_budget_2018_2019.csv", header = None)
