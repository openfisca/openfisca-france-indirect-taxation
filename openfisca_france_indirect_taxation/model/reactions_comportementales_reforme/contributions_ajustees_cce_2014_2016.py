...
class contribution_tva_taux_plein_ajustee_cce_2014_2016(Variable):
    column = FloatCol
    entity_class = Menages
...
class contribution_tva_taux_plein_bis_ajustee_cce_2014_2016(Variable):
    column = FloatCol
    entity_class = Menages
    label = u"Contribution sur la TVA à taux plein après réaction à la réforme - cce 2014-2016"
...
class contribution_tva_taux_reduit_ajustee_cce_2014_2016(Variable):
    column = FloatCol
    entity_class = Menages
...
class contribution_tva_taux_super_reduit_ajustee_cce_2014_2016(Variable):
    column = FloatCol
    entity_class = Menages
...
class difference_contribution_tva_plein_reduit_super_reduit_cce_2014_2016(Variable):
    column = FloatCol
    entity_class = Menages
    label = u"Différence de contribution sur la TVA après réaction à la réforme - cce 2014-2016"
    ...
    def function(self, simulation, period):
        ...
        contribution_plein_ajustee = \
            simulation.calculate('contribution_tva_taux_plein_bis_ajustee_cce_2014_2016', period)
        contribution_reduit_ajustee = \
            simulation.calculate('contribution_tva_taux_reduit_ajustee_cce_2014_2016', period)
        contribution_super_reduit_ajustee = \
            simulation.calculate('contribution_tva_taux_super_reduit_ajustee_cce_2014_2016', period)
        difference = (
