...
@reference_formula
class consommation_coicop12_1(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 1"

    def function(self, simulation, period):
        consommation_coicop12_1 = simulation.calculate('coicop12_1', period)
        return period, consommation_coicop12_1


@reference_formula
class consommation_coicop12_2(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 2"

    def function(self, simulation, period):
        consommation_coicop12_2 = simulation.calculate('coicop12_2', period)
        return period, consommation_coicop12_2


@reference_formula
class consommation_coicop12_3(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 3"

    def function(self, simulation, period):
        consommation_coicop12_3 = simulation.calculate('coicop12_3', period)
        return period, consommation_coicop12_3


@reference_formula
class consommation_coicop12_4(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 4"

    def function(self, simulation, period):
        consommation_coicop12_4 = simulation.calculate('coicop12_4', period)
        return period, consommation_coicop12_4


@reference_formula
class consommation_coicop12_5(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 5"

    def function(self, simulation, period):
        consommation_coicop12_5 = simulation.calculate('coicop12_5', period)
        return period, consommation_coicop12_5


@reference_formula
class consommation_coicop12_6(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 6"

    def function(self, simulation, period):
        consommation_coicop12_6 = simulation.calculate('coicop12_6', period)
        return period, consommation_coicop12_6


@reference_formula
class consommation_coicop12_7(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 7"

    def function(self, simulation, period):
        consommation_coicop12_7 = simulation.calculate('coicop12_7', period)
        return period, consommation_coicop12_7


@reference_formula
class consommation_coicop12_8(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 8"

    def function(self, simulation, period):
        consommation_coicop12_8 = simulation.calculate('coicop12_8', period)
        return period, consommation_coicop12_8


@reference_formula
class consommation_coicop12_9(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 9"

    def function(self, simulation, period):
        consommation_coicop12_9 = simulation.calculate('coicop12_9', period)
        return period, consommation_coicop12_9


@reference_formula
class consommation_coicop12_10(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 10"

    def function(self, simulation, period):
        consommation_coicop12_10 = simulation.calculate('coicop12_10', period)
        return period, consommation_coicop12_10


@reference_formula
class consommation_coicop12_11(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 11"

    def function(self, simulation, period):
        consommation_coicop12_11 = simulation.calculate('coicop12_11', period)
        return period, consommation_coicop12_11


@reference_formula
class consommation_coicop12_12(SimpleFormulaColumn):
    column = FloatCol
    entity_class = Menages
    label = u"Consommation poste coicop 12"

    def function(self, simulation, period):
        consommation_coicop12_12 = simulation.calculate('coicop12_12', period)
        return period, consommation_coicop12_12
