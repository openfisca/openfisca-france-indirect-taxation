...
for i in range(1, 11):
    print(
        float(len(data_matched_random.query("niveau_vie_decile == {}".format(i)).query("aise > 3")))
        / len(data_matched_random.query("niveau_vie_decile == {}".format(i)))
        * 100
    )
...
for i in range(1, 11):
    print(
        float(len(data_matched_random.query("niveau_vie_decile == {}".format(i)).query("aise_froid == 1")))
        / len(data_matched_random.query("niveau_vie_decile == {}".format(i)))
        * 100
    )
...
print(
    "Parmi les personnes déclarant avoir eu froid à cause du prix de l'énergie, quelle est la part \
...
for i in range(1, 11):
    print(
        float(len(data_matched_random.query("niveau_vie_decile == {}".format(i)).query("aise_froid_cout == 1")))
        / len(data_matched_random.query("niveau_vie_decile == {}".format(i)).query("froid_cout == 1"))
    )
print(" ")

print(
    "Parmi les personnes ayant des difficultés dans leur budget, et ayant froid dans leur logement \
