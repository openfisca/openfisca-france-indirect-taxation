...
for reforme in ["rattrapage_diesel", "taxe_carbone", "cce_2015_in_2014", "cce_2016_in_2014"]:
    ...
    menages_reference = survey_scenario.create_data_frame_by_entity(
    ...
    menages_reforme["Cost_after_green_cheques_{}".format(reforme)] = contribution_unite_conso * menages_reforme[
        "ocde10"
    ] - (menages_reforme["total_taxes_energies"] - menages_reference["total_taxes_energies"])

    menages_reforme["precaire_energetique"] = (
        menages_reforme["precarite_energetique_rev_disponible"]
        + menages_reforme["precarite_transports_rev_disponible"]
        - (
            menages_reforme["precarite_energetique_rev_disponible"]
            * menages_reforme["precarite_transports_rev_disponible"]
        )
