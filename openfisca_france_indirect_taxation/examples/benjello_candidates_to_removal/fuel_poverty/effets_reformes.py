...
def effets_reformes_precarite(reforme, year, data_year):
    ...
    indiv_df_reference = survey_scenario.create_data_frame_by_entity(
        simulated_variables, use_baseline=True, period=year
    )
    ...
    for redistribution in ["before", "after"]:
        if redistribution == "after":
            ...
            if reforme != "rattrapage_diesel":
                ...
                menages_reforme["depenses_energies_logement_ajustees_{}".format(reforme)] = (
                    menages_reforme["depenses_energies_logement_ajustees_{}".format(reforme)]
                    - menages_reforme["cheque_vert_logement"]
                )
                menages_reforme["depenses_carburants_corrigees_ajustees_{}".format(reforme)] = (
                    menages_reforme["depenses_carburants_corrigees_ajustees_{}".format(reforme)]
                    - menages_reforme["cheque_vert_transport"]
                )
            if reforme == "rattrapage_diesel":
                menages_reforme = cheque_vert(menages_reference, menages_reforme, reforme)
                menages_reforme["depenses_carburants_corrigees_ajustees_{}".format(reforme)] = (
        ...
        if reforme != "rattrapage_diesel":
            ...
            menages_reforme = brde(
                menages_reforme, "depenses_energies_logement_ajustees_{}".format(reforme), "depenses_tot", "logement"
            )
        ...
        menages_reforme = brde(
            menages_reforme, "depenses_carburants_corrigees_ajustees_{}".format(reforme), "depenses_tot", "transport"
        )
        ...
        # Compute precarite
        if reforme != "rattrapage_diesel":
            menages_reference = precarite(
                menages_reference, "brde_m2_logement_depenses_tot", "tee_10_3_depenses_tot_logement", "logement"
            )
            menages_reforme = precarite(
                menages_reforme, "brde_m2_logement_depenses_tot", "tee_10_3_depenses_tot_logement", "logement"
            )
        ...
        menages_reference = precarite(
            menages_reference, "brde_m2_transport_depenses_tot", "tee_10_3_depenses_tot_transport", "transport"
        )
        menages_reforme = precarite(
            menages_reforme, "brde_m2_transport_depenses_tot", "tee_10_3_depenses_tot_transport", "transport"
        )
        ...
        if reforme != "rattrapage_diesel":
            ...
            menages_reference["precarite_joint"] = (
                menages_reference["precarite_logement"]
                + menages_reference["precarite_transport"]
                - (menages_reference["precarite_logement"] * menages_reference["precarite_transport"])
            )
            menages_reforme["precarite_joint"] = (
                menages_reforme["precarite_logement"]
                + menages_reforme["precarite_transport"]
                - (menages_reforme["precarite_logement"] * menages_reforme["precarite_transport"])
            )
...
if __name__ == "__main__":
    ...
    for reforme in ["rattrapage_diesel", "taxe_carbone", "cce_2015_in_2014", "cce_2016_in_2014"]:
        (
            dict_reformes["logement - {}".format(reforme)],
            dict_reformes["transport - {}".format(reforme)],
            dict_reformes["double - {}".format(reforme)],
            dict_reformes["joint - {}".format(reforme)],
