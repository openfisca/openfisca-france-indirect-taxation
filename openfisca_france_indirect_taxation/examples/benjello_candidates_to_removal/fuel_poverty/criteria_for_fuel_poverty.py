...
data_matched_random["aise_froid"] = (data_matched_random["froid"] == 1) * (data_matched_random["aise"] > 3) * 1
...
print(
    (
        100
        * sum(data_matched_random["pondmen"] * (data_matched_random["aise_froid"] == 1))
        / sum(data_matched_random["pondmen"])
    )
)
print(" ")
print("Par décile de niveau de vie :")
...
for i in range(1, 11):
    ...
    print(
        (
            ...
            "-",
            100
            * sum(data_matched_random_decile["pondmen"] * (data_matched_random_decile["aise_froid"] == 1))
...
print(
    (
        100
        * sum(data_matched_random["pondmen"] * (data_matched_random["aise_froid_cout"] == 1))
        / sum(data_matched_random["pondmen"])
    )
)
print(" ")
...
for i in range(1, 11):
    ...
    print(
        (
            ...
            (
                100
                * sum(data_matched_random_decile["pondmen"] * (data_matched_random_decile["aise_froid_cout"] == 1))
                / sum(data_matched_random_decile["pondmen"])
            ),
        )
    )
    ...
    print(
        (
            ...
            (
                100
                * sum(
                    data_matched_random_decile["pondmen"] * (data_matched_random_decile["part_energies_revtot"] > 0.15)
                )
                / sum(data_matched_random_decile["pondmen"])
            ),
        )
    ...
    print(
        (
            ...
            (
                100
                * sum(
                    data_matched_random_decile["pondmen"] * (data_matched_random_decile["part_energies_revtot"] > 0.1)
                )
                / sum(data_matched_random_decile["pondmen"])
            ),
        )
    ...
    print(
        (
            ...
            (
                100
                * sum(
                    data_matched_random_decile["pondmen"]
