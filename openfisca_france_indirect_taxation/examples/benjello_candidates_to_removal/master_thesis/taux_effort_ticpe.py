...
def plot_taux_effort_ticpe():
    simulated_variables = ["ticpe_totale", "diesel_ticpe", "essence_ticpe", "rev_disp_loyerimput", "depenses_tot"]
    ...
    for category in ["niveau_vie_decile"]:
        ...
        for revenu in ["rev_disp_loyerimput", "depenses_tot"]:
            ...
            for taxe in ["ticpe_totale", "diesel_ticpe", "essence_ticpe"]:
                taxe_indirectes["part_" + taxe] = taxe_indirectes[taxe] / taxe_indirectes[revenu]
