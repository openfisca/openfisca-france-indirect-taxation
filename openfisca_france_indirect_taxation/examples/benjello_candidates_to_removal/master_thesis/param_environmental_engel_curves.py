...
reg_emissions = smf.ols(
    formula="emissions_CO2_energies_totales ~ \
...
simulation_menages["emissions"] = -233.6354 + (
    (
        ...
        - 1425.8345 * strate_1
        + 172.7004 * strate_3
        + 538.9584 * age_group_pr
        + -50.8012 * age_group_pr_2
        + -946.6144 * alone
        + 479.9245 * occupe_both
        + 4344.2562 * gaz
        + 8265.1751 * fioul
    )
...
save_dataframe_to_graph(simulation_menages, "Emissions/parametric_eec.csv")
