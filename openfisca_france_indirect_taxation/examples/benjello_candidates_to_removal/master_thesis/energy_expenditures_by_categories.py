...
simulated_variables = ["depenses_energies_totales", "depenses_energies_logement", "depenses_carburants", "ocde10"]
...
for category in ["niveau_vie_decile", "age_group_pr", "strate"]:
    ...
    df.rename(
        columns={
            "depenses_energies_totales_uc": "Total energy expenditures",
