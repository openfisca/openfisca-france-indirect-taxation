...
for element in products:
    depenses = pd.read_csv(
        os.path.join(assets_directory, "depenses", "depenses_{}_totales_bdf.csv").format(element), sep=",", header=-1
    )
...
parametres_fiscalite_file_path = os.path.join(assets_directory, "legislation", "Parametres fiscalite indirecte.xls")
