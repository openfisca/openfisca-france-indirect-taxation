...
if __name__ == "__main__":
    ...
    for year in [2000, 2005, 2011]:
        ...
        if year < 2007:
            depenses_essence_ticpe = (
                depenses_sp95_ticpe + depenses_sp98_ticpe + depenses_sp_e10_ticpe + depenses_super_plombe_ticpe
            )
        else:
            depenses_essence_ticpe = depenses_sp95_ticpe + depenses_sp98_ticpe + depenses_sp_e10_ticpe
    ...
    writer_carburants = csv.writer(
        open(os.path.join(assets_directory, "depenses", "depenses_ticpe_totales_bdf.csv"), "wb")
    )
    ...
    writer_essence = csv.writer(
        open(os.path.join(assets_directory, "depenses", "depenses_ticpe_essence_bdf.csv"), "wb")
    )
