...
if __name__ == "__main__":
    ...
    for year in [2005]:
        ...
        value_accise_super_plombe = liste_carburants_accise["accise majoree super plombe"].loc["{}".format(year)] / 100

        data_simulation["quantite_diesel"] = data_simulation["diesel_ticpe"] / (value_accise_diesel)
        data_simulation["quantite_sans_plomb"] = (
            data_simulation["sp95_ticpe"] + data_simulation["sp98_ticpe"] + data_simulation["sp_e10_ticpe"]
        ) / (value_accise_sp)
        ...
        data_households = data_households[
            ["quantite_carbu", "quantite_diesel", "quantite_essence"]
        ...
        reg_conso_carbu = smf.ols(
            formula="quantite_carbu ~ \
        ...
        reg_conso_carbu_log = smf.ols(
            formula="ln_quantite_carbu ~ \
        ...
        data_log.to_csv(os.path.join(assets_directory, "quaids", "data_regression.csv"), sep=",")
        # model = \
