...
taxe_indirectes = taxe_indirectes.rename(
    columns={"revtot": "revenu total", "rev_disponible": "revenu disponible"}
)  # , 'taxes_indirectes_total': u'toutes les taxes indirectes'
for revenu in [
    "revenu total"
]:  # [u'revenu total', u'revenu disponible', u'depenses totales', u'toutes les taxes indirectes']
    list_part_taxes = []
    for taxe in ["TVA", "TICPE", "Taxes alcools", "Taxes tabacs"]:  # u'Taxes assurances',
        taxe_indirectes["part " + taxe] = taxe_indirectes[taxe] / taxe_indirectes[revenu]
    ...
    print(
        """Contributions aux différentes taxes indirectes en part de {0},
