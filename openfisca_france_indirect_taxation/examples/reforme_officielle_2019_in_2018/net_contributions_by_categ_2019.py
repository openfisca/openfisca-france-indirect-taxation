...
for category in ["niveau_vie_decile"]:  # ['niveau_vie_decile', 'age_group_pr', 'strate']:
    ...
    df["cout_reforme_cheque_majore"] = (
        df["cout_reforme"]
        + df["cheques_energie_officielle_2019_in_2018"]
        - df["cheques_energie_majore_officielle_2019_in_2018"]
    )
    df["cout_reforme_cheque_philippe"] = (
        df["cout_reforme"]
        + df["cheques_energie_officielle_2019_in_2018"]
        - df["cheques_energie_philippe_officielle_2019_in_2018"]
    )
    ...
    df_reforme["cout_reforme_cheque_majore"] = (
        df_reforme["cout_reforme_cheque_officiel"]
        + df_reforme["cheques_energie_officielle_2019_in_2018"]
        - df_reforme["cheques_energie_majore_officielle_2019_in_2018"]
    )
    df_reforme["cout_reforme_cheque_philippe"] = (
        df_reforme["cout_reforme_cheque_officiel"]
        + df_reforme["cheques_energie_officielle_2019_in_2018"]
        - df_reforme["cheques_energie_philippe_officielle_2019_in_2018"]
    )
