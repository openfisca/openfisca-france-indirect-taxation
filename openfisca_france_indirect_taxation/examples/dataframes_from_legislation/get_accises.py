...
def get_accises_carburants(liste_carburants):
    ...
    for element in liste_carburants:
        accise_dict = legislation_json["children"]["imposition_indirecte"]["children"]["ticpe"]["children"][element]
...
def get_majoration_ticpe(liste_carburants):
    ...
    for element in liste_carburants:
        majoration_dict = legislation_json["children"]["imposition_indirecte"]["children"][element]["children"][
            "alsace"
        ]
