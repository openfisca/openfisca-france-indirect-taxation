...
df_reforme["distance_routiere_hebdomadaire_teg"] = df_reforme["distance_routiere_hebdomadaire_teg"] * (
    df_reforme["distance"] > 0
)
df_reforme["part_distance_teg"] = df_reforme["distance_routiere_hebdomadaire_teg"] / df_reforme["distance"]
...
regression_ols = smf.ols(
    formula="Net_transfers_by_cu_after_recycling ~ \
