...
from openfisca_france_indirect_taxation.examples.reforme_officielle_2018_in_2016.number_fuel_poor import (
    number_fuel_poors,
)
...
def plot_effect_reform_fuel_poors():
    ...
    dict_precarite = dict()
    (dict_precarite["logement"], dict_precarite["transport"], dict_precarite["double"], dict_precarite["joint"]) = (
...
def plot_number_fuel_poors():
    ...
    for type_precarite in types:
        for statut in statuts:
            dataframe[statut][type_precarite] = dict_precarite[type_precarite]["precarite - " + statut]
...
def plot_share_fuel_poors():
    ...
    for type_precarite in types:
        for statut in statuts:
            dataframe[statut][type_precarite] = dict_precarite[type_precarite]["precarite - " + statut] / pop_size
