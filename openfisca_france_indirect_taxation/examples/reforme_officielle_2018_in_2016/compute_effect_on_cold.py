...
from openfisca_france_indirect_taxation.examples.reforme_officielle_2018_in_2016.variation_in_cold_enl import (
    estimate_froid,
)
...
df_reforme["depenses_electricite"] = df_reforme["depenses_electricite"] - df_reforme["cheque_electricite"]
df_reforme["depenses_gaz_ville"] = df_reforme["depenses_electricite"] - df_reforme["cheque_gaz_ville"]
