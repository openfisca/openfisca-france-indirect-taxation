...
def effect_reform_cold():
    ...
    cold["increase_share_cold_before"] = (
        (cold["share_cold_reforme_before"] - cold["share_cold_reference"]) / cold["share_cold_reference"] * 100
    )
    cold["increase_share_cold_after"] = (
        (cold["share_cold_reforme_after"] - cold["share_cold_reference"]) / cold["share_cold_reference"] * 100
    )
