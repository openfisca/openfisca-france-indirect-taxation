...
from openfisca_france_indirect_taxation.examples.utils_example import graph_builder_bar_percent, age_group, energy_modes
...
def number_fuel_poors_by_categ(df_reforme, group, variables_precarite):
    ...
    for variable in variables_precarite:
        for i in elements_group:
            ...
            df_to_plot[variable][i] = (df[variable] * df["pondmen"]).sum() / df["pondmen"].sum()
...
if __name__ == "__main__":
    ...
    variables_precarite = [
        "brde_m2_logement_rev_disponible",
        "tee_10_3_rev_disponible_logement",
        "brde_m2_transport_rev_disponible",
        "tee_10_3_rev_disponible_transport",
        "froid_4_criteres_3_deciles",
    ]
