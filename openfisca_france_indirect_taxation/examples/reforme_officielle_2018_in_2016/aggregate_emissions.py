...
emissions_officielle_plus_cspe["electricite"] = (
    (df_reforme["emissions_CO2_electricite"] - df_reforme["emissions_CO2_electricite_cspe"]) * df_reforme["pondmen"]
).sum() / 1e06
...
# Total
emissions_cce_seulement["total"] = emissions_cce_seulement["total_logement"] + emissions_cce_seulement["carburants"]
emissions_officielle["total"] = emissions_officielle["total_logement"] + emissions_officielle["carburants"]
emissions_officielle_plus_cspe["total"] = (
    emissions_officielle_plus_cspe["total_logement"] + emissions_officielle_plus_cspe["carburants"]
)
emissions_rattrapage_integral["total"] = (
    emissions_rattrapage_integral["total_logement"] + emissions_rattrapage_integral["carburants"]
)
