...
def estimate_froid():
    ...
    dict_prix_combustibles_liquides = legislation_json["children"]["tarifs_energie"]["children"][
        "prix_fioul_domestique"
    ]["children"]["prix_annuel_moyen_fioul_domestique_ttc_livraisons_2000_4999_litres_en_euro_par_litre"]
    ...
    # Quantités gaz
    dict_prix_fixe_gaz_base = legislation_json["children"]["tarifs_energie"]["children"]["tarif_fixe_gdf_ttc"][
        "children"
    ]["base_0_1000"]
    ...
    dict_prix_unitaire_gaz_base = legislation_json["children"]["tarifs_energie"]["children"]["prix_unitaire_gdf_ttc"][
        "children"
    ]["prix_kwh_base_ttc"]
    ...
    data_enl["quantites_base"] = (data_enl["depenses_gaz_ville"] - prix_fixe_base) / prix_unitaire_base

    dict_prix_fixe_gaz_b0 = legislation_json["children"]["tarifs_energie"]["children"]["tarif_fixe_gdf_ttc"][
        "children"
    ]["b0_1000_6000"]
    ...
    dict_prix_unitaire_gaz_b0 = legislation_json["children"]["tarifs_energie"]["children"]["prix_unitaire_gdf_ttc"][
        "children"
    ]["prix_kwh_b0_ttc"]
    ...
    data_enl["quantites_b0"] = (data_enl["depenses_gaz_ville"] - prix_fixe_base) / prix_unitaire_base

    dict_prix_fixe_gaz_1 = legislation_json["children"]["tarifs_energie"]["children"]["tarif_fixe_gdf_ttc"]["children"][
        "b1_6_30000"
    ]
    ...
    dict_prix_unitaire_gaz_1 = legislation_json["children"]["tarifs_energie"]["children"]["prix_unitaire_gdf_ttc"][
        "children"
    ]["prix_kwh_b1_ttc"]
    ...
    data_enl["quantites_b1"] = (data_enl["depenses_gaz_ville"] - prix_fixe_base) / prix_unitaire_base

    data_enl["quantites_gaz_ville"] = (
        data_enl["quantites_base"]
        * (data_enl["quantites_base"] > data_enl["quantites_b0"])
        * (data_enl["quantites_base"] > data_enl["quantites_b1"])
        + data_enl["quantites_b0"]
        * (data_enl["quantites_b0"] > data_enl["quantites_base"])
        * (data_enl["quantites_b0"] > data_enl["quantites_b1"])
        + data_enl["quantites_b1"]
        * (data_enl["quantites_b1"] > data_enl["quantites_base"])
        * (data_enl["quantites_b1"] > data_enl["quantites_b0"])
    )
