...
if __name__ == "__main__":
    ...
    postes_agreges = [
        "poste_agrege_{}".format(index) for index in ["0{}".format(i) for i in range(1, 10)] + ["10", "11", "12"]
    ]

    simulated_variables = ["pondmen", "niveau_vie_decile"]
    ...
    for year in [2000, 2011]:
        ...
        aggregates_data_frame = df_weighted_average_grouped(
            dataframe=simulation_data_frame, groupe="niveau_vie_decile", varlist=simulated_variables
        )
