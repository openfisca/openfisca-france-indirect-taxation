...
if __name__ == "__main__":
    ...
    for year in [2000, 2005, 2011]:
        ...
        Wconcat = df_weighted_average_grouped(dataframe=df, groupe="niveau_vie_decile", varlist=simulated_variables)
        list_alcool_tabac = []
        Wconcat["part_alcool"] = (
        ...
        Wconcat["part_tabac"] = (
            Wconcat["depenses_cigarettes"] + Wconcat["depenses_cigares"] + Wconcat["depenses_tabac_a_rouler"]
        ) / Wconcat["rev_disponible"]
