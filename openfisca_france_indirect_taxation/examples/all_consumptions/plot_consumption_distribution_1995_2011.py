...
from openfisca_france_indirect_taxation.examples.calage_bdf_cn_bis import get_inflators_by_year, get_aggregates_by_year
...
if __name__ == '__main__':
    ...
    for year in [2000, 2005, 2011]:
        ...
        survey_scenario = SurveyScenario.create(year = year, inflation_kwargs = inflation_kwargs)
