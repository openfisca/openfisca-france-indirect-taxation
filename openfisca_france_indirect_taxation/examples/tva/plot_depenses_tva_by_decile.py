    ...
    for year in [2000, 2005, 2011]:
        ...
        for values in simulated_variables:
            pivot_table = pandas.concat(
                [pivot_table, survey_scenario.compute_pivot_table(values=[values], columns=["niveau_vie_decile"])]
            )
        ...
        df_to_graph = taxes_indirectes[
            ["Part TVA taux plein", "Part TVA taux intermédiaire", "Part TVA taux super réduit", "Part TVA taux réduit"]
        ]
