...
survey_scenario = SurveyScenario.create(
    inflation_kwargs=inflation_kwargs, reform=reforme_tva_2019, year=year, data_year=data_year
)
...
df_reforme["recettes_reforme_poste_11_1_3_1"] = (
    df_reforme["recettes_tva_apres_reforme_poste_11_1_3_1"] - df_reforme["recettes_tva_avant_reforme_poste_11_1_3_1"]
)
...
df_reforme["recettes_reforme_poste_11_1_3_2"] = (
    df_reforme["recettes_tva_apres_reforme_poste_11_1_3_2"] - df_reforme["recettes_tva_avant_reforme_poste_11_1_3_2"]
)
recettes_poste_11_1_3_2 = (df_reforme["recettes_reforme_poste_11_1_3_2"] * df_reforme["pondmen"]).sum() / 1e6

recettes_reforme = (
    recettes_poste_11_1_1_1_1 + recettes_poste_11_1_1_1_2 + recettes_poste_11_1_3_1 + recettes_poste_11_1_3_2
)
