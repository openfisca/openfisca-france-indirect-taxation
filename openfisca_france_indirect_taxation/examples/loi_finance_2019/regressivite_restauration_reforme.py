...
for category in ["niveau_vie_decile"]:  # ['niveau_vie_decile', 'age_group_pr', 'strate']:
    ...
    df["poste_agrege_restauration"] = (
        df["poste_11_1_1_1_1"] + df["poste_11_1_1_1_2"] + df["poste_11_1_3_1"] + df["poste_11_1_3_2"]
    )
    ...
    df["augmentation_depenses_restauration_reforme_tva_2019"] = (
        df["poste_agrege_restauration_reforme_tva_2019"] - df["poste_agrege_restauration"]
    )

    df["augmentation_depenses_rev_disp_loyerimput"] = (
        df["augmentation_depenses_restauration_reforme_tva_2019"] / df["rev_disp_loyerimput"]
    )
    df["augmentation_depenses_depenses_tot"] = (
        df["augmentation_depenses_restauration_reforme_tva_2019"] / df["depenses_tot"]
    )
