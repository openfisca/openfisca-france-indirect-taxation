...
class cigares_droit_d_accise(YearlyVariable):
    ...
    def formula(menage, period, parameters):
        ...
        taux_normal_cigare = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_normaux_tabac.taux_normal.cigares
        ...
        taux_special_cigare = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_specifique_tabac.taux_specifique.cigares
...
class cigarette_droit_d_accise(YearlyVariable):
    ...
    def formula(menage, period, parameters):
        ...
        taux_normal_cigarette = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_normaux_tabac.taux_normal.cigarettes
        ...
        taux_special_cigarette = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_specifique_tabac.taux_specifique.cigarettes
...
class tabac_a_rouler_droit_d_accise(YearlyVariable):
    ...
    def formula(menage, period, parameters):
        ...
        taux_normal_tabac_a_rouler = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_normaux_tabac.taux_normal.tabac_a_rouler
        taxe_part_normale_tabac_a_rouler = tax_from_expense_including_tax(
            depenses_tabac_a_rouler, taux_normal_tabac_a_rouler
        )
        ...
        taux_special_tabac_a_rouler = parameters(
            period.start
        ).imposition_indirecte.taxes_tabacs.taux_specifique_tabac.taux_specifique.tabac_rouler
