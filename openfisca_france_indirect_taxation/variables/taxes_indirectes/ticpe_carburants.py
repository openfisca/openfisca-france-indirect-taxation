...
class essence_sp95_e10_ticpe(
    Variable
):  # paru au Journal Officiel le 31 janvier 2009, a autorisé sa distribution sur le marché français depuis le 1er avril 2009.
    value_type = float
    entity = Menage
...
class gpl_carburant_ticpe(Variable):
    ...
    def formula(menage, period, parameters):
        ...
        combustibles_liquides_ticpe = (
            nombre_litres_gpl_carburant * (accise_combustibles_liquides / 100) * coefficient_conversion_kg_vers_litre
        )
        return combustibles_liquides_ticpe
