...
class depense_essence_super_plombe_ttc(Variable):
    ...
    def formula(menage, period):
        ...
        depense_essence_super_plombe_ttc = (
            depense_essence_super_plombe_ht + essence_super_plombe_ticpe + tva_sur_essence_super_plombe
        )
...
class depense_essence_total_ttc(Variable):
    ...
    def formula_2009(menage, period):
        ...
        depense_essence_total_ttc = (
            depense_essence_sp95_ttc + depense_essence_sp98_ttc + depense_essence_e85_ttc + depense_essence_sp95_e10_ttc
        )
    ...
    def formula_1990(menage, period):
        ...
        depense_essence_total_ttc = (
            depense_essence_sp95_ttc + depense_essence_sp98_ttc + depense_essence_super_plombe_ttc
        )
        return depense_essence_total_ttc
