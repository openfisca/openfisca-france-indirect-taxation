...
class depense_gazole_b10_ttc_entree(
    Variable
):  # Il n'y a pour le moment pas assez d'usages de ce carburant (et donc de données)
    value_type = float
    entity = Menage
...
class depense_carburant_total_ttc_sans_distinction_entree(Variable):
    ...
    def formula_2017(menage, period):
        ...
        depense_essence_total_ttc = (
            depense_essence_sp95_ttc
            + depense_essence_sp98_ttc
            + depense_essence_e85_ttc
            + depense_essence_sp95_e10_ttc
            + depense_gazole_b7_ttc
            + depense_gazole_b10_ttc
