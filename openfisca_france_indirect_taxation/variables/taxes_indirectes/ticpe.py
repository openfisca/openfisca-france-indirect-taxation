...
class diesel_ticpe_ajustee(YearlyVariable):
    ...
    def formula(menage, period, parameters):
        ...
        depenses_diesel_htva_ajustees = depenses_diesel_ajustees - tax_from_expense_including_tax(
            depenses_diesel_ajustees, taux_plein_tva
        )
...
class sp_e10_ticpe(Variable):
    ...
    def formula_2009(menage, period, parameters):
        ...
        montant_sp_e10_ticpe = tax_from_expense_including_tax(depenses_sp_e10_htva, taux_implicite_sp_e10)
...
class super_plombe_ticpe(Variable):
    ...
    def formula(menage, period, parameters):
        ...
        montant_super_plombe_ticpe = tax_from_expense_including_tax(
