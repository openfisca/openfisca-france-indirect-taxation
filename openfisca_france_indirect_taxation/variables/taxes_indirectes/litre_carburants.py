...
class nombre_litres_gazole_b7(Variable):
    ...
    def formula(menage, period):
        ...
        nombre_litres_gazole_b7 = np.divide(
            depense_gazole_b7_ttc_entree,
            prix_gazole_b7_ttc,
            out=np.zeros_like(depense_gazole_b7_ttc_entree),
            where=prix_gazole_b7_ttc != 0,
        )
        return nombre_litres_gazole_b7


class nombre_litres_gazole_b10(
    Variable
):  # ATTENTION: pas de prix disponible pour gazole B10, on utilise prix du gazole B7
    value_type = float
    entity = Menage
    ...
    def formula_2017(menage, period):
        ...
        nombre_litres_gazole_b10 = np.divide(
            depense_gazole_b10_ttc_entree,
            prix_gazole_b10_ttc,
            out=np.zeros_like(depense_gazole_b10_ttc_entree),
...
class nombre_litres_essence_sp95_e10(Variable):
    ...
    def formula_2009(menage, period):
        ...
        nombre_litres_essence_sp95_e10 = np.divide(
            depense_essence_sp95_e10_ttc_entree,
            prix_essence_sp95_e10_ttc,
            out=np.zeros_like(depense_essence_sp95_e10_ttc_entree),
...
class nombre_litres_essence_sp95(Variable):
    ...
    def formula(menage, period):
        ...
        nombre_litres_essence_sp95 = np.divide(
            depense_essence_sp95_ttc_entree,
            prix_essence_sp95_ttc,
            out=np.zeros_like(depense_essence_sp95_ttc_entree),
...
class nombre_litres_essence_sp98(Variable):
    ...
    def formula(menage, period):
        ...
        nombre_litres_essence_sp98 = np.divide(
            depense_essence_sp98_ttc_entree,
            prix_essence_sp98_ttc,
            out=np.zeros_like(depense_essence_sp98_ttc_entree),
...
class nombre_litres_essence_super_plombe(Variable):
    ...
    def formula(menage, period):
        ...
        nombre_litres_essence_super_plombe = np.divide(
            depense_essence_super_plombe_ttc_entree,
            prix_essence_super_plombe_ttc,
            out=np.zeros_like(depense_essence_super_plombe_ttc_entree),
...
class nombre_litres_essence_e85(Variable):
    ...
    def formula_2007(menage, period):
        ...
        nombre_litres_essence_e85 = np.divide(
            depense_essence_e85_ttc_entree,
            prix_essence_e85_ttc,
            out=np.zeros_like(depense_essence_e85_ttc_entree),
...
class nombre_litres_essence_total(Variable):
    ...
    def formula_2009(menage, period):
        ...
        nombre_litres_essence_total = (
            nombre_litres_essence_sp95
            + nombre_litres_essence_sp98
            + nombre_litres_essence_e85
            + nombre_litres_essence_sp95_e10
        )
    ...
    def formula_2007(menage, period):
        ...
        nombre_litres_essence_e85 = menage("nombre_litres_essence_e85", period)
        nombre_litres_essence_total = (
            nombre_litres_essence_sp95 + nombre_litres_essence_sp98 + nombre_litres_essence_e85
        )
        return nombre_litres_essence_total
    ...
    def formula_1990(menage, period):
        ...
        nombre_litres_essence_total = (
            nombre_litres_essence_sp95 + nombre_litres_essence_sp98 + nombre_litres_essence_super_plombe
        )
        return nombre_litres_essence_total
...
class nombre_litres_gpl_carburant(Variable):
    ...
    def formula(menage, period):
        ...
        nombre_litres_gpl_carburant = np.divide(
            depense_gpl_carburant_ttc_entree,
            prix_gpl_carburant_ttc,
            out=np.zeros_like(depense_gpl_carburant_ttc_entree),
