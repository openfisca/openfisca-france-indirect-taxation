...
class prix_gazole_b7_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        taux_conversion_gazoles = parameters(
            period
        ...
        accise_gazole_b7_mwh = parameters(
            period
        ...
        majoration_ticpe_gazole_b7_mwh = parameters(
            period
        ...
        maximum_value_affectation = parameters(
            period
        ...
        affectation_ticpe_gazole_b7_hectolitre = parameters(
            period
        ...
        major_mobilites_tipce_gazole_mwh = parameters(
            period
        ...
        accise_gazole_b7_total = (
            accise_gazole_b7_hectolitre
            + majoration_regionale_ticpe_gazole_b7_hectolitre
            - (maximum_value_affectation - affectation_regionale_ticpe_gazole_b7_hectolitre)
            + ((code_region == "11") * major_mobilites_tipce_gazole_hectolitre)
        )
    ...
    def formula_2017(menage, period, parameters):
        ...
        majoration_ticpe_gazole_b7 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_regionale_ticpe_gazole
        majoration_regionale_ticpe_gazole_b7 = np.fromiter(
            (getattr(majoration_ticpe_gazole_b7, region_cell, 0) for region_cell in code_region), dtype=np.float32
        )
        maximum_value_affectation = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_gazole.maximum_value_affectation
        affectation_ticpe_gazole_b7 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_gazole
        ...
        major_mobilites_tipce_gazole = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_ile_de_france_mobilites_ticpe.major_mobilites_tipce_gazole
        accise_gazole_b7_total = (
            accise_gazole_b7
            + majoration_regionale_ticpe_gazole_b7
            - (maximum_value_affectation - affectation_regionale_ticpe_gazole_b7)
            + ((code_region == "11") * major_mobilites_tipce_gazole)
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
        prix_gazole_b7_hors_tva = prix_gazole_b7_hors_remise_ttc * (1 / (1 + taux_plein_tva))
        prix_gazole_b7_ht_avant_remise = prix_gazole_b7_hors_tva - (accise_gazole_b7_total / 100)
...
class prix_gazole_b10_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        accise_gazole_b10_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.accise_energie_metropole.gazoles
...
class prix_essence_sp95_e10_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        code_region = menage("code_region", period)
        taux_conversion_essence_sp95_e10 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.taux_conversion_euro_par_mwh_a_euro_par_hectolitre.taux_conversion_essence_sp95_e10

        accise_super_e10_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.accise_energie_metropole.essence_sp95_e10
        accise_super_e10_hectolitre = accise_super_e10_mwh * taux_conversion_essence_sp95_e10

        major_regionale_ticpe_super_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_regionale_ticpe_sp95_sp98_sp95_e10
        ...
        maximum_value_affectation = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_sp95_e10.maximum_value_affectation
        affectation_ticpe_sp_95_e10_hectolitre = parameters(
            period
        ...
        major_mobilites_tipce_sp95_e10_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_ile_de_france_mobilites_ticpe.major_mobilites_tipce_sp95_e10
        major_mobilites_tipce_sp95_e10_hectolitre = (
            major_mobilites_tipce_sp95_e10_mwh * taux_conversion_essence_sp95_e10
        )

        refraction_corse_tipce_sp95_e10_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.refraction_corse_ticpe.refraction_corse_tipce_sp95_e10
        refraction_corse_tipce_sp95_e10_hectolitre = (
            refraction_corse_tipce_sp95_e10_mwh * taux_conversion_essence_sp95_e10
        )

        accise_sp_e10_ticpe = (
            accise_super_e10_hectolitre
            + majoration_ticpe_super_hectolitre
            - (maximum_value_affectation - affectation_regionale_ticpe_sp95_e10_hectolitre)
            + ((code_region == "11") * major_mobilites_tipce_sp95_e10_hectolitre)
            - ((code_region == "94") * refraction_corse_tipce_sp95_e10_hectolitre)
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
    ...
    def formula_2019(menage, period, parameters):
        ...
        major_regionale_ticpe_super = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_regionale_ticpe_sp95_sp98_sp95_e10
        majoration_ticpe_super = np.fromiter(
            (getattr(major_regionale_ticpe_super, region_cell, 0) for region_cell in code_region), dtype=np.float32
        )
        maximum_value_affectation = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_sp95_e10.maximum_value_affectation
        affectation_ticpe_sp_95_e10 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_sp95_e10
        ...
        major_mobilites_tipce_sp95_e10 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_ile_de_france_mobilites_ticpe.major_mobilites_tipce_sp95_e10
        refraction_corse_tipce_sp95_E10 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.refraction_corse_ticpe.refraction_corse_tipce_sp95_e10
        accise_sp_e10_ticpe = (
            accise_super_e10
            + majoration_ticpe_super
            - (maximum_value_affectation - affectation_regionale_ticpe_sp95_e10)
            + ((code_region == "11") * major_mobilites_tipce_sp95_e10)
            - ((code_region == "94") * refraction_corse_tipce_sp95_E10)
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
        prix_essence_sp95_e10_hors_tva = prix_essence_sp95_e10_hors_remise_ttc * (1 / (1 + taux_plein_tva))
        prix_essence_sp95_e10_ht_avant_remise = prix_essence_sp95_e10_hors_tva - (accise_sp_e10_ticpe / 100)
...
class prix_essence_sp95_e10_ht(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        prix_essence_sp95_e10_hors_remise_ttc = prix_essence_sp95_e10_ht_avant_remise - (
            aide_exceptionnelle_gazole_essence_hl / 100
        )
...
class prix_essence_sp95_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        code_region = menage("code_region", period)
        taux_conversion_essences = parameters(
            period
        ).imposition_indirecte.produits_energetiques.taux_conversion_euro_par_mwh_a_euro_par_hectolitre.taux_conversion_essences

        accise_essences_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.accise_energie_metropole.essences
        ...
        maximum_value_affectation = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_sp95_sp98.maximum_value_affectation
        affectation_ticpe_sp95_sp98_hectolitre = parameters(
            period
        ...
        major_mobilites_tipce_sp95_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_ile_de_france_mobilites_ticpe.major_mobilites_tipce_sp95_sp98
        major_mobilites_tipce_sp95_hectolitre = major_mobilites_tipce_sp95_mwh * taux_conversion_essences

        refraction_corse_tipce_sp95_mwh = parameters(
            period
        ).imposition_indirecte.produits_energetiques.refraction_corse_ticpe.refraction_corse_tipce_sp95_sp98
        refraction_corse_tipce_sp95_hectolitre = refraction_corse_tipce_sp95_mwh * taux_conversion_essences

        accise_sp_95_ticpe = (
            accise_essences_hectolitre
            + majoration_ticpe_super_hectolitre
            - (maximum_value_affectation - affectation_regionale_ticpe_sp95_sp98_hectolitre)
            + ((code_region == "11") * major_mobilites_tipce_sp95_hectolitre)
            - ((code_region == "94") * refraction_corse_tipce_sp95_hectolitre)
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
    ...
    def formula_2017(menage, period, parameters):
        ...
        affectation_ticpe_sp_95_sp98 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.affectation_regionale_ticpe_sp95_sp98
        ...
        major_mobilites_tipce_sp95_sp98 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.majoration_ile_de_france_mobilites_ticpe.major_mobilites_tipce_sp95_sp98
        refraction_corse_tipce_sp95_sp98 = parameters(
            period
        ).imposition_indirecte.produits_energetiques.refraction_corse_ticpe.refraction_corse_tipce_sp95_sp98
        accise_sp_95_ticpe = (
            accise_super95
            + majoration_ticpe_super
            - (maximum_value_affectation - affectation_regionale_ticpe_sp95_sp98)
            + ((code_region == "11") * major_mobilites_tipce_sp95_sp98)
            - ((code_region == "94") * refraction_corse_tipce_sp95_sp98)
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
        prix_essence_sp95_hors_tva = prix_essence_sp95_hors_remise_ttc * (1 / (1 + taux_plein_tva))
        prix_essence_sp95_ht_avant_remise = prix_essence_sp95_hors_tva - (accise_sp_95_ticpe / 100)
...
class prix_essence_sp95_ht(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        prix_essence_sp95_hors_remise_ttc = prix_essence_sp95_ht_avant_remise - (
            aide_exceptionnelle_gazole_essence_hl / 100
        )
...
class prix_essence_sp98_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        accise_sp_98_ticpe = (
            ...
            + majoration_ticpe_super_hectolitre
            - (maximum_value_affectation - affectation_regionale_ticpe_sp95_sp98_hectolitre)
            + ((code_region == "11") * major_mobilites_tipce_sp98_hectolitre)
...
class prix_essence_sp98_ht(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        prix_essence_sp98_hors_remise_ttc = prix_essence_sp98_ht_avant_remise - (
            aide_exceptionnelle_gazole_essence_hl / 100
        )
...
class prix_essence_super_plombe_ht(Variable):
    ...
    def formula(menage, period, parameters):
        ...
        refraction_corse_tipce_super_plombe = parameters(
            period
        ).imposition_indirecte.produits_energetiques.refraction_corse_ticpe.refraction_corse_tipce_super_plombe
        super_plombe_ticpe = (accise_super_plombe_ticpe / 100) - (
            (code_region == "94") * refraction_corse_tipce_super_plombe
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
...
class prix_essence_e85_ht_avant_remise(Variable):
    ...
    def formula_2022(menage, period, parameters):
        ...
        accise_e85_mwh = parameters(
            period.start
        ).imposition_indirecte.produits_energetiques.accise_energie_metropole.superethanol_e85
        taux_conversion_superethanol_e85 = parameters(
            period.start
        ).imposition_indirecte.produits_energetiques.taux_conversion_euro_par_mwh_a_euro_par_hectolitre.taux_conversion_superethanol_e85
    ...
    def formula_2007(menage, period, parameters):
        prix_essence_e85_hors_remise_ttc = menage("prix_essence_e85_hors_remise_ttc", period)
        accise_e85 = parameters(
            period.start
        ).imposition_indirecte.produits_energetiques.ticpe.super_e_85_utilise_comme_carburant_hectolitre
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
...
class prix_gpl_carburant_ht_avant_remise(Variable):
    ...
    def formula(menage, period, parameters):
        prix_gpl_carburant_hors_remise_ttc = menage("prix_gpl_carburant_hors_remise_ttc", period)
        accise_combustibles_liquides = parameters(
            period.start
        ...
        accise_combustibles_liquides_euro_par_hectolitre = (
            accise_combustibles_liquides * coefficient_conversion_kg_vers_litre
        )
        taux_plein_tva = parameters(period).imposition_indirecte.tva.taux_de_tva.taux_normal
        prix_gpl_carburant_hors_tva = prix_gpl_carburant_hors_remise_ttc * (1 / (1 + taux_plein_tva))
        prix_gpl_carburant_ht_avant_remise = prix_gpl_carburant_hors_tva - (
            accise_combustibles_liquides_euro_par_hectolitre / 100
        )
        return prix_gpl_carburant_ht_avant_remise
