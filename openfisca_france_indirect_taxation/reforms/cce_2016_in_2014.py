...
class cce_2016_in_2014(Reform):
    ...
    class depenses_carburants_ajustees_cce_2016_in_2014(YearlyVariable):
        column = FloatCol
        entity = Menage
        label = u"Depenses en carburants après reaction a la reforme - taxes carburants"

        def formula(self, simulation, period):
            depenses_diesel_ajustees = simulation.calculate('depenses_diesel_ajustees_cce_2016_in_2014', period)
            depenses_essence_ajustees = simulation.calculate('depenses_essence_ajustees_cce_2016_in_2014', period)
    ...
    class depenses_carburants_corrigees_ajustees_cce_2016_in_2014(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_diesel_ajustees = simulation.calculate('depenses_diesel_corrigees_ajustees_cce_2016_in_2014', period)
            depenses_essence_ajustees = simulation.calculate('depenses_essence_corrigees_ajustees_cce_2016_in_2014', period)
            depenses_carburants_ajustees = depenses_diesel_ajustees + depenses_essence_ajustees

            return depenses_carburants_ajustees

    
    class depenses_diesel_ajustees_cce_2016_in_2014(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class depenses_energies_logement_ajustees_cce_2016_in_2014(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            depenses_gaz_ville_ajustees = simulation.calculate('depenses_gaz_ville_ajustees_cce_2016_in_2014', period)
            depenses_gaz_liquefie = simulation.calculate('depenses_gaz_liquefie', period)
            depenses_combustibles_liquides_ajustees = simulation.calculate('depenses_combustibles_liquides_ajustees_cce_2016_in_2014', period)
    ...
    class depenses_essence_ajustees_cce_2016_in_2014(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class diesel_ticpe(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            depenses_diesel_ajustees_cce_2016_in_2014 = \
                simulation.calculate('depenses_diesel_ajustees_cce_2016_in_2014', period)
    ...
    class quantites_combustibles_liquides(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_combustibles_liquides_ajustees_cce_2016_in_2014 = \
                simulation.calculate('depenses_combustibles_liquides_ajustees_cce_2016_in_2014', period)
            prix_fioul_ttc = \
                simulation.legislation_at(period.start).tarification_energie_logement.prix_fioul_domestique.prix_annuel_moyen_du_fioul_domestique_ttc_livraisons_de_2000_a_4999_litres_en_euro_par_litre
            reforme_combustibles_liquides = \
                simulation.legislation_at(period.start).cce_2016_in_2014.combustibles_liquides_2014_2016
    ...
    class quantites_gaz_contrat_optimal_ajustees_cce_2016_in_2014(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_gaz_ville_ajustees_cce_2016_in_2014 = simulation.calculate('depenses_gaz_ville_ajustees_cce_2016_in_2014', period)
            depenses_gaz_tarif_fixe = simulation.calculate('depenses_gaz_tarif_fixe', period)
    ...
    class quantites_sp_e10(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_essence_ajustees_cce_2016_in_2014 = \
                simulation.calculate('depenses_essence_ajustees_cce_2016_in_2014', period)
    ...
    class tva_taux_plein(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_tva_taux_plein_ajustees = \
                simulation.calculate('depenses_tva_taux_plein_ajustees_cce_2016_in_2014', period)
    ...
    class tva_taux_plein_bis(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_tva_taux_plein_ajustees = \
                simulation.calculate('depenses_tva_taux_plein_bis_ajustees_cce_2016_in_2014', period)
    ...
    class tva_taux_reduit(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_tva_taux_reduit_ajustees = \
                simulation.calculate('depenses_tva_taux_reduit_ajustees_cce_2016_in_2014', period)
    ...
    class tva_taux_super_reduit(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_tva_taux_super_reduit_ajustees = \
                simulation.calculate('depenses_tva_taux_super_reduit_ajustees_cce_2016_in_2014', period)
    ...
    def apply(self):
        self.update_variable(self.depenses_carburants_ajustees_cce_2016_in_2014)
        self.update_variable(self.depenses_carburants_corrigees_ajustees_cce_2016_in_2014)
        self.update_variable(self.depenses_diesel_ajustees_cce_2016_in_2014)
        ...
        self.update_variable(self.depenses_essence_ajustees_cce_2016_in_2014)
