...
class cce_2016_in_2014(Reform):
    ...
    class depenses_diesel_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
        ...
        def formula(self, simulation, period):
            ...
            return depenses_diesel_ajustees_cce_2014_2016
    
    
    class depenses_essence_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
        ...
        def formula(self, simulation, period):
            ...
            return depenses_essence_ajustees_cce_2014_2016
    
    
    class depenses_combustibles_liquides_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
        ...
        def formula(self, simulation, period):
            ...
            reforme_combustibles_liquides = \
                simulation.legislation_at(period.start).cce_2016_in_2014.combustibles_liquides
            combustibles_liquides_elasticite_prix = simulation.calculate('elas_price_2_2', period)
            depenses_combustibles_liquides_ajustees_cce_2014_2016 = \
                depenses_combustibles_liquides * (1 + (1 + combustibles_liquides_elasticite_prix) * reforme_combustibles_liquides / prix_fioul_ttc)
    
            return depenses_combustibles_liquides_ajustees_cce_2014_2016
    
    
    class depenses_gaz_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class depenses_tva_taux_plein_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class depenses_tva_taux_plein_bis_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class depenses_tva_taux_reduit_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class depenses_tva_taux_super_reduit_ajustees_cce_2014_2016(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    class combustibles_liquides_ticpe(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            reforme_combustibles_liquides = \
                simulation.legislation_at(period.start).cce_2016_in_2014.combustibles_liquides_2014_2016
            ...
            depenses_combustibles_liquides_ajustees = simulation.calculate('depenses_combustibles_liquides_ajustees_cce_2014_2016', period)
    ...
    class quantites_combustibles_liquides(YearlyVariable):
        ...
        def formula(self, simulation, period):
            depenses_combustibles_liquides_ajustees_cce_2014_2016 = \
                simulation.calculate('depenses_combustibles_liquides_ajustees_cce_2014_2016', period)
            prix_fioul_ttc = \
                simulation.legislation_at(period.start).tarification_energie_logement.prix_fioul_domestique.prix_annuel_moyen_du_fioul_domestique_ttc_livraisons_de_2000_a_4999_litres_en_euro_par_litre
            reforme_combustibles_liquides = \
                simulation.legislation_at(period.start).cce_2016_in_2014.combustibles_liquides_2014_2016
            quantites_combustibles_liquides_ajustees = depenses_combustibles_liquides_ajustees_cce_2014_2016 / (prix_fioul_ttc + reforme_combustibles_liquides)
    
            return quantites_combustibles_liquides_ajustees
    
    
    class quantites_gaz_contrat_optimal_ajustees_cce_2016_in_2014(YearlyVariable):
        column = FloatCol
        entity = Menage
    ...
    def apply(self):
        self.update_variable(self.depenses_diesel_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_essence_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_combustibles_liquides_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_gaz_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_tva_taux_plein_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_tva_taux_plein_bis_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_tva_taux_reduit_ajustees_cce_2014_2016)
        self.update_variable(self.depenses_tva_taux_super_reduit_ajustees_cce_2014_2016)
        ...
        self.update_variable(self.quantites_gaz_contrat_optimal_ajustees_cce_2016_in_2014)
