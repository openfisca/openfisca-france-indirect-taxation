...
def build_reform(tax_benefit_system):
    ...
    class depenses_diesel_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
    ...
    class depenses_essence_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
        entity_class = Menages
    ...
    class depenses_tva_taux_plein_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
        entity_class = Menages
    ...
    class depenses_tva_taux_plein_bis_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
        entity_class = Menages
        label = u"Dépenses sur les biens assujetis à la TVA à taux plein après réaction à la réforme - taxes carburants"
    ...
    class depenses_tva_taux_reduit_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
        entity_class = Menages
    ...
    class depenses_tva_taux_super_reduit_ajustees_rattrapage_diesel(Reform.Variable):
        column = FloatCol
        entity_class = Menages
