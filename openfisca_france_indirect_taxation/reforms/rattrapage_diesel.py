...
from openfisca_france_indirect_taxation.variables.consommation import emissions_co2, quantites_energie
...
class reforme_rattrapage_diesel(Reform):
    ...
    class depenses_diesel_corrigees_ajustees_rattrapage_diesel(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            reforme_diesel = parameters(period.start).rattrapage_diesel.diesel
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_diesel_ajustees_rattrapage_diesel = depenses_diesel * (
    ...
    class depenses_essence_ajustees_rattrapage_diesel(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_essence_ajustees_rattrapage_diesel = depenses_essence * (
    ...
    class depenses_tva_taux_plein_bis_ajustees_rattrapage_diesel(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein = menage("depenses_tva_taux_plein", period)
            taux_plein = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            abaissement_tva_taux_plein = parameters(period.start).rattrapage_diesel.abaissement_tva_taux_plein_bis
            elasticite = menage("elas_price_3_3", period)
            depenses_tva_taux_plein_ajustees = depenses_tva_taux_plein * (
                1 + (1 + elasticite) * (-abaissement_tva_taux_plein) / (1 + taux_plein)
            )
    ...
    class depenses_tva_taux_reduit_ajustees_rattrapage_diesel(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            abaissement_tva_taux_reduit = parameters(period.start).rattrapage_diesel.abaissement_tva_taux_reduit
            elasticite = menage("elas_price_3_3", period)
    ...
    class depenses_tva_taux_super_reduit_ajustees_rattrapage_diesel(YearlyVariable):
        ...
        entity = Menage
        label = (
            "Depenses sur les biens assujetis a la TVA tx super reduit après reaction a la reforme - taxes carburants"
        )
        ...
        def formula(menage, period, parameters):
            ...
            abaissement_tva_taux_super_reduit = parameters(
                period.start
            ).rattrapage_diesel.abaissement_tva_taux_super_reduit
            elasticite = menage("elas_price_3_3", period)
    ...
    class diesel_ticpe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_ajustees_rattrapage_diesel = menage(
                "depenses_diesel_corrigees_ajustees_rattrapage_diesel", period
            )
            depenses_diesel_htva_ajustees = depenses_diesel_ajustees_rattrapage_diesel - tax_from_expense_including_tax(
                depenses_diesel_ajustees_rattrapage_diesel, taux_plein_tva
            )
    ...
    class quantites_sp_e10(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_essence_ajustees_rattrapage_diesel = menage(
                "depenses_essence_corrigees_ajustees_rattrapage_diesel", period
            )
    ...
    class tva_taux_plein(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein_ajustees = menage("depenses_tva_taux_plein_ajustees_rattrapage_diesel", period)
    ...
    class tva_taux_plein_bis(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein_ajustees = menage("depenses_tva_taux_plein_bis_ajustees_rattrapage_diesel", period)
    ...
    class tva_taux_reduit(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_reduit_ajustees = menage("depenses_tva_taux_reduit_ajustees_rattrapage_diesel", period)
    ...
    class tva_taux_super_reduit(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_super_reduit_ajustees = menage(
                "depenses_tva_taux_super_reduit_ajustees_rattrapage_diesel", period
            )
