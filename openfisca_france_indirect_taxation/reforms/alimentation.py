...
from openfisca_france_indirect_taxation.variables.consommation.categories_fiscales import (
...
class reforme_alimentation(Reform):
    ...
    def apply(self):
        ...
        categories_fiscales.loc[categories_fiscales.categorie_fiscale == "vin", "categorie_fiscale"] = ""
