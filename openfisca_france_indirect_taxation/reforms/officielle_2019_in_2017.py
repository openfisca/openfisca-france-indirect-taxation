...
class officielle_2019_in_2017(Reform):
    ...
    class combustibles_liquides_ticpe_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            reforme_combustibles_liquides = \
                simulation.legislation_at(period.start).officielle_2019_in_2017.combustibles_liquides_2019_in_2017
    ...
    class depenses_diesel_corrigees_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            reforme_diesel = simulation.legislation_at(period.start).officielle_2019_in_2017.diesel_2019_in_2017
    ...
    class depenses_essence_corrigees_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            reforme_essence = simulation.legislation_at(period.start).officielle_2019_in_2017.essence_2019_in_2017
            carburants_elasticite_prix = simulation.calculate('elas_price_1_1', period)
    ...
    class depenses_gaz_ville_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(self, simulation, period):
            ...
            reforme_gaz = \
                simulation.legislation_at(period.start).officielle_2019_in_2017.gaz_ville_2019_in_2017
    ...
    class taxe_gaz_ville_officielle_2019_in_2017(YearlyVariable):
        ...
        def formula(self, simulation, period):
            quantites_gaz_ajustees = simulation.calculate('quantites_gaz_final_officielle_2019_in_2017', period)
            reforme_gaz = simulation.legislation_at(period.start).officielle_2019_in_2017.gaz_ville_2019_in_2017
