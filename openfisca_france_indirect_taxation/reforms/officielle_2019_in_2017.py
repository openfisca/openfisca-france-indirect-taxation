    ...
    reform_legislation_subtree = {
        ...
        "children": {
            "diesel_2019_in_2017": {
                ...
                "format": 'float',
                "unit": 'currency',
                "values": [{'start': '2016-01-01', 'value': 2 * 2.6 + 266 * (0.055 - 0.0305)}]
                },
            "essence_2019_in_2017": {
                ...
                "format": "float",
                "unit": 'currency',
                "values": [{'start': '2016-01-01', 'value': 242 * (0.055 - 0.0305)}],
                },
            "combustibles_liquides_2019_in_2017": {
                ...
                "format": "float",
                "unit": 'currency',
                "values": [{'start': '2016-01-01', 'value': 3.24 * (0.055 - 0.0305)}],
                },
            "gaz_ville_2019_in_2017": {
                ...
                "format": 'float',
                "unit": 'currency',
                "values": [{'start': '2016-01-01', 'value': 0.241 * (0.055 - 0.0305)}],
                },
            },
        }
