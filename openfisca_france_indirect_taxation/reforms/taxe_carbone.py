...
class taxe_carbone(Reform):
    ...
    class depenses_diesel_corrigees_ajustees_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_ajustees_taxe_carbone = depenses_diesel * (
    ...
    class depenses_energies_logement_ajustees_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            depenses_combustibles_liquides_ajustees = menage(
                "depenses_combustibles_liquides_ajustees_taxe_carbone", period
            )
    ...
    class depenses_essence_corrigees_ajustees_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_essence_ajustees_taxe_carbone = depenses_essence * (
    ...
    class depenses_combustibles_liquides_ajustees_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_combustibles_liquides_ajustees_taxe_carbone = depenses_combustibles_liquides * (
                1 + (1 + combustibles_liquides_elasticite_prix) * reforme_fioul / prix_fioul_ttc
            )
    ...
    class depenses_tva_taux_super_reduit_ajustees_taxe_carbone(YearlyVariable):
        ...
        entity = Menage
        label = (
            "Dépenses sur les biens assujetis à la TVA à taux super reduit après réaction à la réforme - taxe carbone"
        )
    ...
    class diesel_ticpe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_ajustees_taxe_carbone = menage("depenses_diesel_corrigees_ajustees_taxe_carbone", period)
            depenses_diesel_htva_ajustees = depenses_diesel_ajustees_taxe_carbone - tax_from_expense_including_tax(
                depenses_diesel_ajustees_taxe_carbone, taux_plein_tva
            )
    ...
    class emissions_CO2_electricite(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            quantites_electricite_ajustees = menage(
                "quantites_electricite_selon_compteur_ajustees_taxe_carbone", period
            )
    ...
    class combustibles_liquides_ticpe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            taux_implicite_fioul_ajuste = (accise_fioul_ajustee * (1 + taux_plein_tva)) / (
            ...
            depenses_fioul_ajustees_htva = depenses_fioul_ajustees - tax_from_expense_including_tax(
                depenses_fioul_ajustees, taux_plein_tva
            )
            montant_fioul_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_fioul_ajustees_htva, taux_implicite_fioul_ajuste
            )
    ...
    class quantites_combustibles_liquides(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_combustibles_liquides_ajustees_taxe_carbone = menage(
                "depenses_combustibles_liquides_ajustees_taxe_carbone", period
            )
            prix_fioul_ttc = parameters(
                period.start
            ...
            reforme_fioul = parameters(period.start).taxe_carbone.combustibles_liquides
            quantites_combustibles_liquides_ajustees = depenses_combustibles_liquides_ajustees_taxe_carbone / (
                prix_fioul_ttc + reforme_fioul
            )
    ...
    class quantites_electricite_selon_compteur_ajustees_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_electricite_ajustees_taxe_carbone = menage("depenses_electricite_ajustees_taxe_carbone", period)
            depenses_electricite_tarif_fixe = menage("depenses_electricite_tarif_fixe", period)
    ...
    class total_taxes_energies_taxe_carbone(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total = taxe_diesel + taxe_electricite + taxe_essence + taxe_combustibles_liquides + taxe_gaz
    ...
    class tva_taux_plein(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein_ajustees = menage("depenses_tva_taux_plein_ajustees_taxe_carbone", period)
    ...
    class tva_taux_plein_bis(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein_ajustees = menage("depenses_tva_taux_plein_bis_ajustees_taxe_carbone", period)

            taux_plein = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            abaissement_tva_taux_plein = parameters(period.start).taxe_carbone.abaissement_tva_taux_plein_bis
            nouveau_taux_plein = taux_plein - abaissement_tva_taux_plein
    ...
    class tva_taux_reduit(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_reduit_ajustees = menage("depenses_tva_taux_reduit_ajustees_taxe_carbone", period)
    ...
    class tva_taux_super_reduit(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_super_reduit_ajustees = menage(
                "depenses_tva_taux_super_reduit_ajustees_taxe_carbone", period
            )
