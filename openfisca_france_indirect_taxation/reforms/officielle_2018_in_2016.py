        ...
        data={
            ...
            "electricite_cspe": {
                ...
                "values": {
                    "2016-01-01": (44.6 - 10)
                    / 1e3
                    * 0.09,  # Différence entre prix de la réforme et prix (environ 10€) sur le marché EU-ETS
                },
            },
            "gaz_ville_2016_2018": {
                "description": "Surcroît de prix du gaz (en euros par kWh)",
                "unit": "currency",
                "values": {"2016-01-01": (44.6 - 22) / 1e3 * 0.241},
            },
...
class reforme_officielle_2018_in_2016(Reform):
    ...
    class cheques_energie_integral_inconditionnel_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period):
            revenu_reforme = menage("revenu_reforme_officielle_2018_in_2016", period)
    ...
    class cheques_energie_integral_inconditionnel_officielle_2018_in_2016_plus_cspe(YearlyVariable):
        ...
        def formula(menage, period):
            revenu_reforme = menage("revenu_reforme_officielle_2018_in_2016_plus_cspe", period)
            ocde10 = menage("ocde10", period)
            pondmen = menage("pondmen", period)
    ...
    class cheques_energie_integral_inconditionnel_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period):
            revenu_reforme = menage("revenu_reforme_cce_seulement", period)
            ocde10 = menage("ocde10", period)
            pondmen = menage("pondmen", period)
    ...
    class cheques_energie_integral_inconditionnel_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period):
            revenu_reforme = menage("revenu_reforme_rattrapage_integral", period)
            ocde10 = menage("ocde10", period)
            pondmen = menage("pondmen", period)
    ...
    class cheques_energie_ruraux_by_energy_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            cheque_final = (cheque * (1 - ratio_ruraux - ratio_by_energy)) + cheque_ruraux + cheque_by_energy
    ...
    class combustibles_liquides_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            reforme_combustibles_liquides = parameters(
                period.start
            ).officielle_2018_in_2016.combustibles_liquides_2016_2018
            accise_combustibles_liquides_ajustee = accise_combustibles_liquides_ticpe + reforme_combustibles_liquides
            prix_fioul_ttc = parameters(
                period.start
            ...
            depenses_combustibles_liquides_ajustees = menage(
                "depenses_combustibles_liquides_officielle_2018_in_2016", period
            )
            depenses_combustibles_liquides_htva = (
                depenses_combustibles_liquides_ajustees
                - tax_from_expense_including_tax(depenses_combustibles_liquides_ajustees, taux_plein_tva)
            )
            montant_combustibles_liquides_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_combustibles_liquides_htva, taux_implicite_combustibles_liquides_ajuste
            )
    ...
    class depenses_combustibles_liquides_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_combustibles_liquides_officielle_2018_in_2016 = depenses_combustibles_liquides * (
                1 + (1 + combustibles_liquides_elasticite_prix) * reforme_combustibles_liquides / prix_fioul_ttc
            )
    ...
    class depenses_diesel_corrigees_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_cce_seulement = depenses_diesel * (
                1 + (1 + carburants_elasticite_prix) * reforme_diesel / diesel_ttc
            )
    ...
    class depenses_diesel_corrigees_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_diesel_officielle_2018_in_2016 = depenses_diesel * (
                1 + (1 + carburants_elasticite_prix) * reforme_diesel / diesel_ttc
            )
    ...
    class depenses_diesel_corrigees_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_diesel_rattrapage_integral = depenses_diesel * (
                1 + (1 + carburants_elasticite_prix) * reforme_diesel / diesel_ttc
            )
    ...
    class depenses_electricite_cspe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_electricite_ajustees_variables = depenses_electricite_variables * (
            ...
            depenses_electricite_ajustees = depenses_electricite_ajustees * (
                depenses_electricite > min_tarif_fixe
    ...
    class depenses_essence_corrigees_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            carburants_elasticite_prix = menage("elas_price_1_1", period)
            depenses_essence_officielle_2018_in_2016 = depenses_essence * (
                1 + (1 + carburants_elasticite_prix) * reforme_essence / super_95_ttc
            )
    ...
    class depenses_gaz_ville_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_gaz_variables = depenses_gaz_variables * (
                1 + (1 + gaz_elasticite_prix) * reforme_gaz / depenses_gaz_prix_unitaire
            )
    ...
    class depenses_tva_taux_plein_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            abaissement_tva_taux_plein = parameters(
                period.start
            ).officielle_2018_in_2016.abaissement_tva_taux_plein_2016_2018
            elasticite = menage("elas_price_3_3", period)
            depenses_tva_taux_plein_ajustees = depenses_tva_taux_plein * (
    ...
    class depenses_tva_taux_plein_bis_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_tva_taux_plein = menage("depenses_tva_taux_plein", period)
            taux_plein = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            abaissement_tva_taux_plein_bis = parameters(
                period.start
            ).officielle_2018_in_2016.abaissement_tva_taux_plein_bis_2016_2018
            elasticite = menage("elas_price_3_3", period)
            depenses_tva_taux_plein_bis_ajustees = depenses_tva_taux_plein * (
    ...
    class depenses_tva_taux_reduit_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            abaissement_tva_taux_reduit = parameters(
                period.start
            ).officielle_2018_in_2016.abaissement_tva_taux_reduit_2016_2018
            elasticite = menage("elas_price_3_3", period)
            depenses_tva_taux_reduit_ajustees = depenses_tva_taux_reduit * (
                1 + (1 + elasticite) * (-abaissement_tva_taux_reduit) / (1 + taux_reduit)
            )
    ...
    class depenses_tva_taux_super_reduit_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            abaissement_tva_taux_super_reduit = parameters(
                period.start
            ).officielle_2018_in_2016.abaissement_tva_taux_super_reduit_2016_2018
            elasticite = menage("elas_price_3_3", period)
            depenses_tva_taux_super_reduit_ajustees = depenses_tva_taux_super_reduit * (
    ...
    class diesel_ticpe_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            majoration_ticpe_diesel = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.major_regionale_ticpe_gazole.alsace

            accise_diesel = parameters(period.start).imposition_indirecte.produits_energetiques.ticpe.gazole

            accise_diesel_ticpe = (
                accise_diesel + majoration_ticpe_diesel if majoration_ticpe_diesel is not None else accise_diesel
            )
            ...
            taux_implicite_diesel_ajuste = (accise_diesel_ticpe_ajustee * (1 + taux_plein_tva)) / (
                prix_diesel_ttc_ajuste - accise_diesel_ticpe_ajustee * (1 + taux_plein_tva)
            )

            depenses_diesel_cce_seulement = menage("depenses_diesel_corrigees_cce_seulement", period)
            depenses_diesel_htva_ajustees = depenses_diesel_cce_seulement - tax_from_expense_including_tax(
                depenses_diesel_cce_seulement, taux_plein_tva
            )
            montant_diesel_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_diesel_htva_ajustees, taux_implicite_diesel_ajuste
            )
    ...
    class diesel_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_officielle_2018_in_2016 = menage(
                "depenses_diesel_corrigees_officielle_2018_in_2016", period
            )
            depenses_diesel_htva_ajustees = depenses_diesel_officielle_2018_in_2016 - tax_from_expense_including_tax(
                depenses_diesel_officielle_2018_in_2016, taux_plein_tva
            )
            montant_diesel_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_diesel_htva_ajustees, taux_implicite_diesel_ajuste
            )
    ...
    class diesel_ticpe_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            depenses_diesel_rattrapage_integral = menage("depenses_diesel_corrigees_rattrapage_integral", period)
            depenses_diesel_htva_ajustees = depenses_diesel_rattrapage_integral - tax_from_expense_including_tax(
                depenses_diesel_rattrapage_integral, taux_plein_tva
            )
            montant_diesel_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_diesel_htva_ajustees, taux_implicite_diesel_ajuste
            )
    ...
    class emissions_CO2_carburants_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            emissions_diesel = parameters(period.start).imposition_indirecte.emissions_CO2.carburants.CO2_diesel
            emissions_essence = parameters(period.start).imposition_indirecte.emissions_CO2.carburants.CO2_essence
    ...
    class emissions_CO2_combustibles_liquides_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            quantites_combustibles_liquides_ajustees = menage(
                "quantites_combustibles_liquides_officielle_2018_in_2016", period
            )
            emissions_combustibles_liquides = parameters(
                period.start
            ).imposition_indirecte.emissions_CO2.energie_logement.CO2_combustibles_liquides
    ...
    class emissions_CO2_electricite_cspe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            emissions_eletricite = parameters(
                period.start
            ).imposition_indirecte.emissions_CO2.energie_logement.CO2_electricite
    ...
    class emissions_CO2_energies_totales_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            emissions_combustibles_liquides_ajustees = menage(
                "emissions_CO2_combustibles_liquides_officielle_2018_in_2016", period
            )
    ...
    class emissions_CO2_energies_totales_officielle_2018_in_2016_plus_cspe(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            emissions_energies_ajustees = (
                emissions_carburants_ajustees
                + emissions_electricite_ajustees
                + emissions_combustibles_liquides_ajustees
                + emissions_gaz_ajustees
            )
            return emissions_energies_ajustees
    ...
    class emissions_CO2_gaz_ville_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            emissions_gaz = parameters(period.start).imposition_indirecte.emissions_CO2.energie_logement.CO2_gaz_ville
    ...
    class gains_tva_carburants_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_carburants_corrigees_officielle_2018_in_2016 = menage(
                "depenses_carburants_corrigees_officielle_2018_in_2016", period
            )
            ...
            tva_depenses_carburants_corrigees = (taux_plein_tva / (1 + taux_plein_tva)) * depenses_carburants_corrigees
            gains_tva_carburants = (
                tva_depenses_carburants_corrigees_officielle_2018_in_2016 - tva_depenses_carburants_corrigees
            )
    ...
    class gains_tva_combustibles_liquides_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            depenses_combustibles_liquides_officielle_2018_in_2016 = menage(
                "depenses_combustibles_liquides_officielle_2018_in_2016", period
            )
            ...
            gains_tva_combustibles_liquides = (
                tva_depenses_combustibles_liquides_officielle_2018_in_2016 - tva_depenses_combustibles_liquides
            )
    ...
    class gains_tva_gaz_ville_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            tva_depenses_gaz_ville_officielle_2018_in_2016 = (taux_plein_tva / (1 + taux_plein_tva)) * (
                depenses_gaz_ville_officielle_2018_in_2016 - depenses_gaz_tarif_fixe
            )
            depenses_gaz_ville = menage("depenses_gaz_ville", period)
            tva_depenses_gaz_ville = (taux_plein_tva / (1 + taux_plein_tva)) * (
                depenses_gaz_ville - depenses_gaz_tarif_fixe
            )
            gains_tva_gaz_ville = tva_depenses_gaz_ville_officielle_2018_in_2016 - tva_depenses_gaz_ville
    ...
    class pertes_financieres_avant_redistribution_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            depenses_energies_logement_officielle_2018_in_2016 = menage(
                "depenses_energies_logement_officielle_2018_in_2016", period
            )
            depenses_carburants_officielle_2018_in_2016 = menage(
                "depenses_carburants_corrigees_officielle_2018_in_2016", period
            )
    ...
    class pertes_financieres_avant_redistribution_officielle_2018_in_2016_plus_cspe(YearlyVariable):
        ...
        def formula(menage, period):
            depenses_energies_totales = menage("depenses_energies_totales", period)
            depenses_energies_logement_officielle_2018_in_2016_plus_cspe = menage(
                "depenses_energies_logement_officielle_2018_in_2016_plus_cspe", period
            )
            depenses_carburants_officielle_2018_in_2016 = menage(
                "depenses_carburants_corrigees_officielle_2018_in_2016", period
            )
    ...
    class quantites_combustibles_liquides_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            quantites_combustibles_liquides_ajustees = depenses_combustibles_liquides_officielle_2018_in_2016 / (
                prix_fioul_ttc + reforme_combustibles_liquides
            )
    ...
    class quantites_diesel_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_diesel_officielle_2018_in_2016 = menage("depenses_diesel_corrigees_cce_seulement", period)
            diesel_ttc = parameters(period.start).prix_carburants.diesel_ttc
            reforme_diesel = parameters(period.start).officielle_2018_in_2016.diesel_cce_seulement
    ...
    class quantites_diesel_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_diesel_officielle_2018_in_2016 = menage("depenses_diesel_corrigees_rattrapage_integral", period)
            diesel_ttc = parameters(period.start).prix_carburants.diesel_ttc
            taxe_essence = parameters(period.start).imposition_indirecte.produits_energetiques.ticpe.super_95_98
            taxe_diesel = parameters(period.start).imposition_indirecte.produits_energetiques.ticpe.gazole
            reforme_diesel = taxe_essence - taxe_diesel
    ...
    class quantites_electricite_selon_compteur_cspe(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_electricite_ajustees = menage("depenses_electricite_cspe", period)
            depenses_electricite_tarif_fixe = menage("depenses_electricite_tarif_fixe", period)
            depenses_electricite_ajustees_variables = depenses_electricite_ajustees - depenses_electricite_tarif_fixe

            depenses_electricite_prix_unitaire = menage("depenses_electricite_prix_unitaire", period)
            reforme_electricite = parameters(period.start).officielle_2018_in_2016.electricite_cspe

            quantites_electricite_ajustees = depenses_electricite_ajustees_variables / (
                depenses_electricite_prix_unitaire + reforme_electricite
            )

            quantites_electricite_avant_reforme = menage("quantites_electricite_selon_compteur", period)
            quantites_electricite_ajustees = quantites_electricite_ajustees * (quantites_electricite_avant_reforme > 0)
    ...
    class quantites_essence_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula_1990(menage, period):
            quantites_sp95_ajustees = menage("quantites_sp95_officielle_2018_in_2016", period)
            quantites_sp98_ajustees = menage("quantites_sp98_officielle_2018_in_2016", period)
            quantites_super_plombe_ajustees = menage("quantites_super_plombe_officielle_2018_in_2016", period)
    ...
    class quantites_sp_e10_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            depenses_essence_officielle_2018_in_2016 = menage(
                "depenses_essence_corrigees_officielle_2018_in_2016", period
            )
    ...
    class quantites_super_plombe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            part_super_plombe = parameters(period.start).imposition_indirecte.part_type_supercarburants.super_plombe
            ...
            quantites_super_plombe_ajustees = (
                depenses_super_plombe_ajustees / (super_plombe_ttc + reforme_essence) * 100
            )
    ...
    class revenu_reforme_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total_taxes_energies_cce_seulement = menage("total_taxes_energies_cce_seulement", period)
            tarifs_sociaux_electricite = menage("tarifs_sociaux_electricite", period)
            tarifs_sociaux_gaz = menage("tarifs_sociaux_gaz", period)
    ...
    class revenu_reforme_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period):
            total_taxes_energies = menage("total_taxes_energies", period)
            total_taxes_energies_officielle_2018_in_2016 = menage(
                "total_taxes_energies_officielle_2018_in_2016", period
            )
    ...
    class revenu_reforme_officielle_2018_in_2016_plus_cspe(YearlyVariable):
        ...
        def formula(menage, period):
            total_taxes_energies = menage("total_taxes_energies", period)
            total_taxes_energies_officielle_2018_in_2016_plus_cspe = menage(
                "total_taxes_energies_officielle_2018_in_2016_plus_cspe", period
            )
    ...
    class revenu_reforme_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period):
            total_taxes_energies = menage("total_taxes_energies", period)
            total_taxes_energies_rattrapage_integral = menage("total_taxes_energies_rattrapage_integral", period)
    ...
    class sp_e10_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            accise_super_e10 = parameters(period.start).imposition_indirecte.produits_energetiques.ticpe.super_e10
            # If the parameter does not have a defined value, it returns None
            majoration_ticpe_super_e10 = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.major_regionale_ticpe_super.alsace
            ...
            taux_implicite_sp_e10_ajuste = (accise_ticpe_super_e10_ajustee * (1 + taux_plein_tva)) / (
            ...
            sp_e10_depenses_htva_ajustees = sp_e10_depenses_ajustees - tax_from_expense_including_tax(
                sp_e10_depenses_ajustees, taux_plein_tva
            )
            montant_sp_e10_ticpe_ajuste = tax_from_expense_including_tax(
                sp_e10_depenses_htva_ajustees, taux_implicite_sp_e10_ajuste
            )
    ...
    class sp95_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            majoration_ticpe_super95 = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.major_regionale_ticpe_super.alsace
            accise_ticpe_super95 = (
                accise_super95 + majoration_ticpe_super95 if majoration_ticpe_super95 is not None else accise_super95
            )
            reforme_essence = parameters(period.start).officielle_2018_in_2016.essence_2016_2018
            accise_ticpe_super95_ajustee = accise_ticpe_super95 + reforme_essence
            super_95_ttc = parameters(period.start).prix_carburants.super_95_ttc
            super_95_ttc_ajuste = super_95_ttc + reforme_essence
            taux_implicite_sp95_ajuste = (accise_ticpe_super95_ajustee * (1 + taux_plein_tva)) / (
            ...
            depenses_sp_95_htva_ajustees = depenses_sp_95_ajustees - tax_from_expense_including_tax(
                depenses_sp_95_ajustees, taux_plein_tva
            )
            montant_sp95_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_sp_95_htva_ajustees, taux_implicite_sp95_ajuste
            )
    ...
    class sp98_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            ...
            majoration_ticpe_super98 = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.major_regionale_ticpe_super.alsace
            accise_ticpe_super98 = (
                accise_super98 + majoration_ticpe_super98 if majoration_ticpe_super98 is not None else accise_super98
            )
            ...
            taux_implicite_sp98_ajuste = (accise_ticpe_super98_ajustee * (1 + taux_plein_tva)) / (
            ...
            depenses_sp_98_htva_ajustees = depenses_sp_98_ajustees - tax_from_expense_including_tax(
                depenses_sp_98_ajustees, taux_plein_tva
            )
            montant_sp98_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_sp_98_htva_ajustees, taux_implicite_sp98_ajuste
            )
    ...
    class super_plombe_ticpe_officielle_2018_in_2016(YearlyVariable):
        ...
        def formula(menage, period, parameters):
            taux_plein_tva = parameters(period.start).imposition_indirecte.tva.taux_de_tva.taux_normal
            accise_super_plombe_ticpe = parameters(
                period.start
            ).imposition_indirecte.produits_energetiques.ticpe.super_plombe
            ...
            taux_implicite_super_plombe_ajuste = (accise_super_plombe_ticpe_ajustee * (1 + taux_plein_tva)) / (
            ...
            part_super_plombe = parameters(period.start).imposition_indirecte.part_type_supercarburants.super_plombe
            depenses_super_plombe_ajustees = depenses_essence_officielle_2018_in_2016 * part_super_plombe
            depenses_super_plombe_htva_ajustees = depenses_super_plombe_ajustees - tax_from_expense_including_tax(
                depenses_super_plombe_ajustees, taux_plein_tva
            )
            montant_super_plombe_ticpe_ajuste = tax_from_expense_including_tax(
                depenses_super_plombe_htva_ajustees, taux_implicite_super_plombe_ajuste
            )
    ...
    class total_taxes_energies_cce_seulement(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total = taxe_diesel + taxe_essence + taxe_combustibles_liquides + taxe_gaz_ville
    ...
    class total_taxes_energies_officielle_2018_in_2016_plus_cspe(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total = taxe_diesel + taxe_electricite_cspe + taxe_essence + taxe_combustibles_liquides + taxe_gaz_ville
    ...
    class total_taxes_energies_rattrapage_integral(YearlyVariable):
        ...
        def formula(menage, period):
            ...
            total = taxe_diesel + taxe_essence + taxe_combustibles_liquides
