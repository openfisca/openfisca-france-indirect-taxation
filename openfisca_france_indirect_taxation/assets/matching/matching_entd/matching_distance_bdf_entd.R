...
write.csv(fused.nnd.m,
          file = "C:/Users/t.douenne/GitHub/openfisca-france-indirect-taxation/openfisca_france_indirect_taxation/assets/matching/matching_entd/data_matched_distance.csv"
)
