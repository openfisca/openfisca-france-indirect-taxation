...
from openfisca_france_indirect_taxation.build_survey_data.matching_bdf_enl.step_4_1_clean_data import (
    prepare_bdf_enl_matching_data,
)
from openfisca_france_indirect_taxation.build_survey_data.matching_bdf_emp.step_4_1_save_data import (
    prepare_bdf_emp_matching_data,
)
from openfisca_france_indirect_taxation.build_survey_data.matching_bdf_emp.step_6_1_calage_depenses_carburants import (
    cale_bdf_emp_matching_data,
)
from openfisca_france_indirect_taxation.build_survey_data.matching_erfs.step_4_1_clean_data import (
...
def main(year_data):
    ...
    data_matched_enl = pandas.read_csv(
        os.path.join(assets_directory, "matching", "matching_enl", "data_matched_rank.csv"), sep=",", decimal="."
    )
    ...
    data_matched_emp = pandas.read_csv(
        os.path.join(assets_directory, "matching", "matching_emp", "data_matched_final.csv"), sep=",", decimal="."
    )
    ...
    data_frame.to_csv(os.path.join(assets_directory, "matching", "data_for_run_all_{}.csv".format(year_data)), sep=",")
    return data_frame
