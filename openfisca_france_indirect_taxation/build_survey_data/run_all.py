...
from openfisca_france_indirect_taxation.build_survey_data.step_1_1_homogeneisation_donnees_depenses import (
    build_depenses_homogenisees,
)


from openfisca_france_indirect_taxation.build_survey_data.step_1_2_imputations_loyers_proprietaires import (
    build_imputation_loyers_proprietaires,
)

from openfisca_france_indirect_taxation.build_survey_data.step_2_homogeneisation_vehicules import (
    build_homogeneisation_vehicules,
)

from openfisca_france_indirect_taxation.build_survey_data.step_3_homogeneisation_caracteristiques_menages import (
    build_homogeneisation_caracteristiques_sociales,
)
from openfisca_france_indirect_taxation.build_survey_data.step_4_homogeneisation_revenus_menages import (
...
def run_all_steps(temporary_store=None, year_calage=2017, skip_matching=False):
    ...
    if year_data == 2005:
        nullified_variables = (
            ...
            + ["age{}".format(i) for i in range(3, 14)]
            + ["agecj", "agfinetu", "agfinetu_cj", "nenfhors"]
        )
