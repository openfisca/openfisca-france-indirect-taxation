...
import numpy as np
from openfisca_france_indirect_taxation.build_survey_data.matching_bdf_emp.step_1_2_build_dataframes_vehicles import (
...
def create_new_variables(year_data):
    ...
    def create_new_variables_(data, option=None):
        ...
        data.rename(
            columns={"diesel": "nb_diesel", "essence": "nb_essence", "autre_carbu": "nb_autre_carbu"}, inplace=True
        )
