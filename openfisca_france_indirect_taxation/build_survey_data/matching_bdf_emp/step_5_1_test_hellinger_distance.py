...
from openfisca_france_indirect_taxation.build_survey_data.matching_bdf_emp.step_3_1_compute_hellinger_distance import (
    hellinger_distance,
)
...
varlist = [
    "distance_annuelle",
    "distance_diesel_annuelle",
    "distance_essence_annuelle",
    "distance_annuelle_niveau_vie_decile",
    "distance_annuelle_tuu",
]
for var in varlist:
