...
from ipp_macro_series_parser.agregats_transports.poids_carburants.parser_cleaner_prix_carburants import (
    prix_annuel_carburants_90_16,
...
prix_mensuel_carbu_match_to_vag[["annee", "mois"]] = prix_mensuel_carbu_match_to_vag[["annee", "mois"]].astype(str)
...
prix_mensuel_carbu_match_to_vag.to_csv(
    os.path.join(assets_directory, "prix", "prix_mensuel_carbu_match_to_vag.csv"), sep=","
)
