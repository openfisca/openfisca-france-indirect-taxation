...
def add_fiscal_categories_to_bdf_nomenclature(bdf_nomenclature, to_csv=False):
    ...
    fiscal_rules = [
        ...
        {"value": "01.1.5.2", "categorie_fiscale": "tva_taux_plein"},  # Margarine
        {
            ...
            "origin": "TAXIPP",
        },  # Saindoux autres graisses d'origine animale
        ...
        {"value": "02.3", "categorie_fiscale": "", "origin": "COICOP UN"},  # Stupéfiants
        {
            ...
            "categorie_fiscale": "",
            "origin": "TAXIPP",
        },  # Alcools, tabacs et stupéfiants offerts à un autre
        ...
        {"value": "04", "categorie_fiscale": "tva_taux_plein"},
        {
            ...
            "start": 1998,
            "stop": 2011,
        },  # Combustible solide de résidence principale
        {"value": "04.5.4.1", "categorie_fiscale": "tva_taux_intermediaire", "start": 2012},
        {
            "value": ["04.4.1.1", "04.4.2.1", "04.4.3.1"],
            "categorie_fiscale": "tva_taux_reduit",
            "stop": 2011,
        },  # Enlèvement des ordures ménagères, assainissement et distribution d'eau,
        # qui sont au taux réduit de 1994 à 2011
        {
            "value": ["04.4.1.1", "04.4.2.1"],
        ...
        {"value": ["04.1.1.1", "04.1.2.1"], "categorie_fiscale": ""},  # Loyers et charges locatives
        {
            "value": "04.3.2.1",
            "categorie_fiscale": "tva_taux_intermediaire",
        },  # Services d'entretien et réparation de logements
