...
def apply_modification(
    coicop_nomenclature=None, value=None, categorie_fiscale=None, origin=None, start=1994, stop=2024
):
    """
        ...
        if not filled_start_stop:
            ...
            if overlap_selection.any():
                if (overlap_selection & equal_start & equal_stop).any():
                    ...
                    coicop_nomenclature.loc[overlap_selection & equal_start & equal_stop, "categorie_fiscale"] = (
                        categorie_fiscale
                    )
                    ...
                    coicop_nomenclature = _handle_overlap_start(
                        coicop_nomenclature, overlap_selection, start, stop, categorie_fiscale
                    )
                elif (overlap_selection & equal_stop).any():
                    # Chevauchement à la fin: découpe l'intervalle existant
                    coicop_nomenclature = _handle_overlap_stop(
                        coicop_nomenclature, overlap_selection, start, stop, categorie_fiscale
                    )
                else:
                    # Chevauchement au milieu: découpe en trois parties
                    coicop_nomenclature = _handle_overlap_middle(
                        coicop_nomenclature, overlap_selection, start, stop, categorie_fiscale
                    )
    else:
...
def add_fiscal_categories_to_coicop_nomenclature(coicop_nomenclature, to_csv=False):
    ...
    fiscal_rules = [
        ...
        {
            "value": ["4.4.1.0.1", "4.4.2.0.1", "4.4.3.0.1"],
            "categorie_fiscale": "tva_taux_reduit",
            "stop": 2011,
        ...
        {
            "value": ["4.4.2.0.1", "4.4.3.0.1"],
            "categorie_fiscale": "tva_taux_intermediaire",
            "start": 2012,
        },  # Puis au taux intermédiaire à partir de 2012
        {
            "value": "4.4.1.0.1",
            "categorie_fiscale": "tva_taux_reduit",
            "start": 2012,
        },  # sauf pour la distribution d'eau qui reste au taux réduit
        {
            "value": "4.3.2.2.1",
            "categorie_fiscale": "tva_taux_intermediaire",
        ...
        {"value": 5, "categorie_fiscale": "tva_taux_plein"},
        {
            "value": "5.6.2.1",
            "categorie_fiscale": "tva_taux_intermediaire",
        },  # Services domestiques (ménage, garde enfant, jardinage)
        # 06 Santé
        ...
        {"value": "7.3.3", "categorie_fiscale": "tva_taux_reduit", "stop": 2024},  # Transport aérien de passagers
        {
            ...
            "categorie_fiscale": "tva_taux_reduit",
            "stop": 2011,
        },  # Transport maritime et fluvial de passager
        ...
        {
            "value": ["11.1.1.1.4", "11.1.1.1.5", "11.1.1.1.6", "11.1.1.1.8"],
        ...
        },  # Consommation de boissons alcoolisées
        {
            ...
            "categorie_fiscale": "tva_taux_plein",
            "stop": 2009,
        },  # Restauration avec service à table (hors boissons alcoolisées)
        ...
        {"value": "11.1.1.1.", "categorie_fiscale": "tva_taux_intermediaire", "start": 2012},
        {
            ...
            "categorie_fiscale": "tva_taux_plein",
            "stop": 1997,
        },  # Restauration sans service à table (rapide et à emporter)
...
def get_categorie_fiscale(value, year=None, assertion_error=True):
    ...
    file_path = os.path.join(legislation_directory, "coicop_legislation.csv")
